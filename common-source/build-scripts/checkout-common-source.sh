...
LOGFILE=`pwd`/checkout-common-source.log

WORKING_DIR=`pwd`
echo WORKING DIR $WORKING_DIR
SOURCE_DIR=${WORKING_DIR}/common-source
mkdir -p $SOURCE_DIR
pushd $SOURCE_DIR
...
# Same, but for Git
# we include the project path since not all content is in the MPLAB XC32 project.
all_git_repos=(
  xc32/pic32m-docs
