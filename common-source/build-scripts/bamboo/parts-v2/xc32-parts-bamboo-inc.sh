...
<html lang="en-US">
    ...
    <body>
        If you are not redirected automatically, follow the <a href='http://chn-sv-cyclone.microchip.com:8085/browse/M32DEV-PSN32-PJU-${bamboo_BILD_NUMBER}/test'>Link to test result page</a>
    </body>
</html>
EOF
