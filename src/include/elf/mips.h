...
/* 
  How the processor-specific flag bits are assigned:
  f0000000	Arch/ISA
  0f000000	ASEs (not enough bits here)
  00ff0000	Mach/CPU type (loosely encoded, could encode more ASEs here)
  0000f000	"old" ABI (o32, o64, eabi32, eabi64) 
  00000800	?unused (snarf for more ASEs?)
  00000400	?unused (snarf for more ASEs?)
  00000200	64-bit floating point on 32-bit ISA
  00000100	32-bit integers on 64-bit ISA
  00000080	[sgi] mips .option first
  00000040	?unused
  00000020	[sgi] "new" ABI (n32)
  00000010	[sgi] UCODE
  00000008	[sgi] XGOT
  00000004	[sgi] calls PIC code
  00000002	[sgi] is PIC code
  00000001	[sgi] noreorder
*/
...
/* Still need these, but not enough bits:
     MIPS-3D extension 
...
#ifdef MIPSSDE
#ifdef notdef
/* Legacy MIPS/Algorithmics usage */
/* XXX Clashes with ARCH_ASE_MDMX and ARCH_ASE_M16 above */
/* Compiled for 64-bit ISA, but with -mfp32 */
#define EF_MIPS_SDE_FP32	0x08000000

/* Compiled for 64-bit ISA, but with -mgp32  */
#define EF_MIPS_SDE_GP32	0x04000000
#endif

/* Compiled for 32-bit ISA, but with -mfp64 */
#define EF_MIPS_SDE_FP64	0x02000000
#endif
...
/* Code compiled for 32-bit ISA but with 64-bit FPU */
