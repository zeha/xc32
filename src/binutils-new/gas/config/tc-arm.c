...
do_t_add_sub_w (void)
{
  ...
  /* If Rn is REG_PC, this is ADR; if Rn is REG_SP, then this is the
     SP-{plus,minus}-immediate form of the instruction.  */
...
#define THUMB_VARIANT &fpu_vfp_ext_fma
 /* Mnemonics shared by Neon and VFP.  These are included in the
    ...
    FMA instructions.  */
 nCEF(vfma,     vfma,    3, (RNSDQ, oRNSDQ, RNSDQ), neon_fmac),
 nCEF(vfms,     vfms,    3, (RNSDQ, oRNSDQ, RNSDQ), neon_fmac),
 ...
 nCE(vfnma,     vfnma,   3, (RVSD, RVSD, RVSD), vfp_nsyn_nmul),
 nCE(vfnms,     vfnms,   3, (RVSD, RVSD, RVSD), vfp_nsyn_nmul),
...
static const struct arm_arch_option_table arm_archs[] =
{
  ...
  {"tag13",		ARM_ARCH_TAG13,	 FPU_ARCH_VFP},
