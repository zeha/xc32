...
#endif
#ifndef DISABLE_DSP2_ASE_SELECTION
  ...
  *input_line_pointer = '\0';
  ...
  if (strcmp (name, "reorder") == 0)
    ...
    mips_opts.single_float = 0;
	   ...
	   || strcmp (name, "mips16e") == 0
	   )
    mips_opts.mips16 = 1;
  else if (strcmp (name, "nomips16") == 0
	   || strcmp (name, "noMIPS-16") == 0
	   || strcmp (name, "nomips16e") == 0
	   )
    mips_opts.mips16 = 0;
#ifndef DISABLE_SMARTMIPS_ASE_SELECTION
...

#if !defined(DISABLE_CPU_SELECTION) && !defined(DISABLE_ABI_SELECTION)
static void
