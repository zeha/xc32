...
#define OP_SH_CCC		8
#define OP_MASK_CODE20		0xfffffu /* 20 bit syscall/breakpoint code.  */
#define OP_SH_CODE20		6
#define OP_MASK_SHAMT		0x1f
#define OP_SH_SHAMT		6
#define OP_MASK_FD		0x1f
#define OP_SH_FD		6
#define OP_MASK_TARGET		0x3ffffffu
#define OP_SH_TARGET		0
#define OP_MASK_COPZ		0x1ffffffu
#define OP_SH_COPZ		0
#define OP_MASK_IMMEDIATE	0xfffful
#define OP_SH_IMMEDIATE		0ul
#define OP_MASK_DELTA		0xfffful
