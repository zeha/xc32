...
struct cgraph_varpool_node GTY(())
{
  ...
  /* If using section relative addressing, these hold the local offsets from
     the section's base. */
  int bss_off;
  int data_off;
  /* Indicate if this node has been analysed and included in the list of 
     section relative addresses */
  bool sectrel_node;

  /* Static count of the number of references occurred in the program. */
  int use;
};
...
struct cgraph_varpool_static_node GTY((chain_next ("%h.next")))
{
  struct cgraph_varpool_node *node;
  struct cgraph_varpool_static_node *next;
};

extern GTY(()) struct cgraph_varpool_static_node *cgraph_varpool_data_list;
extern GTY(()) struct cgraph_varpool_static_node *cgraph_varpool_udata_list;
extern GTY(()) int cgraph_varpool_data_align;
extern GTY(()) int cgraph_varpool_udata_align;
...
void cgraph_varpool_analyse_decl (tree decl);
void cgraph_varpool_record_static (struct cgraph_varpool_node *);
void cgraph_varpool_output_statics (struct cgraph_varpool_static_node *);
void cgraph_varpool_calculate_offsets (void);
struct cgraph_varpool_node* section_relative_symbol (rtx);
