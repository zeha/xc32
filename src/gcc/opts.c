  ...
  if (optimize_size)
    {
      ...
      set_param_value ("inline-unit-growth", 0);
      flag_inline_functions = 1;

      /* Web dont't increase size and its relatively quick to run. */
      flag_web = 1;
    }
		      ...
		      int value ATTRIBUTE_UNUSED)
{
  ...
  switch (code)
    ...
    case OPT_fsection_relative_addressing:
      flag_section_relative_addressing = value;
      break;
