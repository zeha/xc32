...
extern bool decl_data_section (tree, int);
extern bool decl_data_section_1 (tree, int, int);

extern bool decl_bss_section (tree, int);
extern bool decl_bss_section_1 (tree, int, int);

/* This can be used to compute RELOC for the function above, when
   given a constant expression.  */
extern int compute_reloc_for_constant (tree);

extern int contains_pointers_p (tree);
