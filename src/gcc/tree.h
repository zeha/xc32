...
#define DECL_UNIQUE_SECTION(NODE) (DECL_CHECK (NODE)->decl.unique_section_flag)
...
#define unsigned_V4QI_type_node		global_trees[TI_UV4QI_TYPE]
...
#define V4QI_type_node			global_trees[TI_V4QI_TYPE]
