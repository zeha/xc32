...
struct gcc_target
{
  ...
  struct sched
  {
    ...
    /* Check if register is to be scheduled with clobber dependencies.  */
    bool (* regno_clobber_dependencies) (int);
  } sched;
  ...
  */
  ...
  /* For the web phase, target may mark registers for no renaming.  */
  void (* web_mark_register) (rtx, char *);
