...
(define_constants
  [(UNSPEC_LOAD_DF_LOW		 0)
   ...
   (UNSPEC_SAVE_MIPS16E		90)
   (UNSPEC_RESTORE_MIPS16E	91)

   ;; Constants used in paired single comparisons
   (UNSPEC_C_F_PS		201)
   (UNSPEC_C_UN_PS		202)
   (UNSPEC_C_EQ_PS		203)
   (UNSPEC_C_UEQ_PS		204)
   ...
   (UNSPEC_CABS_F_PS		218)
   (UNSPEC_CABS_UN_PS		219)
   (UNSPEC_CABS_EQ_PS		220)
   (UNSPEC_CABS_UEQ_PS		221)
   (UNSPEC_CABS_OLT_PS		222)
   (UNSPEC_CABS_ULT_PS		223)
   (UNSPEC_CABS_OLE_PS		224)
   (UNSPEC_CABS_ULE_PS		225)
   (UNSPEC_CABS_SF_PS		226)
   (UNSPEC_CABS_NGLE_PS		227)
   (UNSPEC_CABS_SEQ_PS		228)
   (UNSPEC_CABS_NGL_PS		229)
   (UNSPEC_CABS_LT_PS		230)
   (UNSPEC_CABS_NGE_PS		231)
   (UNSPEC_CABS_LE_PS		232)
   (UNSPEC_CABS_NGT_PS		233)
   ...
   (UNSPEC_CABS_F_4S		266)
   (UNSPEC_CABS_UN_4S		267)
   (UNSPEC_CABS_EQ_4S		268)
   (UNSPEC_CABS_UEQ_4S		269)
   (UNSPEC_CABS_OLT_4S		270)
   (UNSPEC_CABS_ULT_4S		271)
   (UNSPEC_CABS_OLE_4S		272)
   (UNSPEC_CABS_ULE_4S		273)
   (UNSPEC_CABS_SF_4S		274)
   (UNSPEC_CABS_NGLE_4S		275)
   (UNSPEC_CABS_SEQ_4S		276)
   (UNSPEC_CABS_NGL_4S		277)
   (UNSPEC_CABS_LT_4S		278)
   (UNSPEC_CABS_NGE_4S		279)
   (UNSPEC_CABS_LE_4S		280)
   (UNSPEC_CABS_NGT_4S		281)

   (UNSPEC_CABS_F_S		282)
   (UNSPEC_CABS_UN_S		283)
   (UNSPEC_CABS_EQ_S		284)
   (UNSPEC_CABS_UEQ_S		285)
   (UNSPEC_CABS_OLT_S		286)
   (UNSPEC_CABS_ULT_S		287)
   (UNSPEC_CABS_OLE_S		288)
   (UNSPEC_CABS_ULE_S		289)
   (UNSPEC_CABS_SF_S		290)
   (UNSPEC_CABS_NGLE_S		291)
   (UNSPEC_CABS_SEQ_S		292)
   (UNSPEC_CABS_NGL_S		293)
   (UNSPEC_CABS_LT_S		294)
   (UNSPEC_CABS_NGE_S		295)
   (UNSPEC_CABS_LE_S		296)
   (UNSPEC_CABS_NGT_S		297)
   (UNSPEC_CABS_F_D		298)
   (UNSPEC_CABS_UN_D		299)
   (UNSPEC_CABS_EQ_D		300)
   (UNSPEC_CABS_UEQ_D		301)
   (UNSPEC_CABS_OLT_D		302)
   (UNSPEC_CABS_ULT_D		303)
   (UNSPEC_CABS_OLE_D		304)
   (UNSPEC_CABS_ULE_D		305)
   (UNSPEC_CABS_SF_D		306)
   (UNSPEC_CABS_NGLE_D		307)
   (UNSPEC_CABS_SEQ_D		308)
   (UNSPEC_CABS_NGL_D		309)
   (UNSPEC_CABS_LT_D		310)
   (UNSPEC_CABS_NGE_D		311)
   (UNSPEC_CABS_LE_D		312)
   (UNSPEC_CABS_NGT_D		313)

   (UNSPEC_MOVE_TF_PS		314)
   ...
   ;; MIPS DSP ASE Revision 0.98x 6/14/2005
   (UNSPEC_ADDQ_PH		400)
   (UNSPEC_ADDQ_S_PH		401)
   (UNSPEC_ADDQ_QH		402)
   (UNSPEC_ADDQ_S_QH		403)
   (UNSPEC_ADDQ_S_W		404)
   (UNSPEC_ADDQ_PW		405)
   (UNSPEC_ADDQ_S_PW		406)
   (UNSPEC_ADDU_QB		407)
   (UNSPEC_ADDU_S_QB		408)
   (UNSPEC_ADDU_OB		409)
   (UNSPEC_ADDU_S_OB		410)
   (UNSPEC_SUBQ_PH		411)
   (UNSPEC_SUBQ_S_PH		412)
   (UNSPEC_SUBQ_QH		413)
   (UNSPEC_SUBQ_S_QH		414)
   (UNSPEC_SUBQ_S_W		415)
   (UNSPEC_SUBQ_PW		416)
   (UNSPEC_SUBQ_S_PW		417)
   (UNSPEC_SUBU_QB		418)
   (UNSPEC_SUBU_S_QB		419)
   (UNSPEC_SUBU_OB		420)
   (UNSPEC_SUBU_S_OB		421)
   (UNSPEC_ADDSC		422)
   (UNSPEC_ADDWC		423)
   (UNSPEC_MODSUB		424)
   (UNSPEC_RADDU_W_QB		425)
   (UNSPEC_RADDU_L_OB		426)
   (UNSPEC_ABSQ_S_PH		427)
   (UNSPEC_ABSQ_S_W		428)
   (UNSPEC_ABSQ_QH		429)
   (UNSPEC_ABSQ_S_QH		430)
   (UNSPEC_ABSQ_PW		431)
   (UNSPEC_ABSQ_S_PW		432)
   (UNSPEC_PRECRQ_QB_PH		433)
   (UNSPEC_PRECRQ_PH_W		434)
   (UNSPEC_PRECRQ_RS_PH_W	435)
   (UNSPEC_PRECRQ_OB_QH		436)
   (UNSPEC_PRECRQ_QH_PW		437)
   (UNSPEC_PRECRQ_RS_QH_PW	438)
   (UNSPEC_PRECRQ_PW_L		439)
   (UNSPEC_PRECRQU_S_QB_PH	440)
   (UNSPEC_PRECRQU_S_OB_QH	441)
   (UNSPEC_PRECRQU_S_QH_PW	442)
   (UNSPEC_PRECRQU_S_PW_L	443)
   (UNSPEC_PRECEQ_W_PHL		444)
   (UNSPEC_PRECEQ_W_PHR		445)
   (UNSPEC_PRECEQ_PW_QHL	446)
   (UNSPEC_PRECEQ_PW_QHR	447)
   (UNSPEC_PRECEQ_PW_QHLA	448)
   (UNSPEC_PRECEQ_PW_QHRA	449)
   (UNSPEC_PRECEQ_L_PWL		450)
   (UNSPEC_PRECEQ_L_PWR		451)
   (UNSPEC_PRECEQU_PH_QBL	452)
   (UNSPEC_PRECEQU_PH_QBR	453)
   (UNSPEC_PRECEQU_PH_QBLA	454)
   (UNSPEC_PRECEQU_PH_QBRA	455)
   (UNSPEC_PRECEQU_QH_OBL	456)
   (UNSPEC_PRECEQU_QH_OBR	457)
   (UNSPEC_PRECEQU_QH_OBLA	458)
   (UNSPEC_PRECEQU_QH_OBRA	459)
   (UNSPEC_PRECEU_PH_QBL	460)
   (UNSPEC_PRECEU_PH_QBR	461)
   (UNSPEC_PRECEU_PH_QBLA	462)
   (UNSPEC_PRECEU_PH_QBRA	463)
   (UNSPEC_SHLL_QB		464)
   (UNSPEC_SHLL_OB		465)
   (UNSPEC_SHLL_PH		466)
   (UNSPEC_SHLL_S_PH		467)
   (UNSPEC_SHLL_QH		468)
   (UNSPEC_SHLL_S_QH		469)
   (UNSPEC_SHLL_S_W		470)
   (UNSPEC_SHLL_PW		471)
   (UNSPEC_SHLL_S_PW		472)
   (UNSPEC_SHRL_QB		473)
   (UNSPEC_SHRL_OB		474)
   (UNSPEC_SHRA_PH		475)
   (UNSPEC_SHRA_R_PH		476)
   (UNSPEC_SHRA_R_W		477)
   (UNSPEC_SHRA_QH		478)
   (UNSPEC_SHRA_R_QH		479)
   (UNSPEC_SHRA_PW		480)
   (UNSPEC_SHRA_R_PW		481)
   (UNSPEC_MULEU_S_PH_QBL	482)
   (UNSPEC_MULEU_S_PH_QBR	483)
   (UNSPEC_MULQ_RS_PH		484)
   (UNSPEC_MULQ_QH		485)
   (UNSPEC_MULQ_RS_QH		486)
   (UNSPEC_MULEQ_S_W_PHL	487)
   (UNSPEC_MULEQ_S_W_PHR	488)
   (UNSPEC_MULEQ_PW_QHL		489)
   (UNSPEC_MULEQ_PW_QHR		490)
   (UNSPEC_MULEQ_S_PW_QHL	491)
   (UNSPEC_MULEQ_S_PW_QHR	492)
   (UNSPEC_DPAU_H_QBL		493)
   (UNSPEC_DPAU_H_QBR		494)
   (UNSPEC_DPAU_H_QBL_64	495)
   (UNSPEC_DPAU_H_QBR_64	496)
   (UNSPEC_DPSU_H_QBL		497)
   (UNSPEC_DPSU_H_QBR		498)
   (UNSPEC_DPSU_H_QBL_64	499)
   (UNSPEC_DPSU_H_QBR_64	500)
   (UNSPEC_DPAQ_S_W_PH		501)
   (UNSPEC_DPAQ_S_W_PH_64	502)
   (UNSPEC_DPAQ_W_QH		503)
   (UNSPEC_DPAQ_S_W_QH		504)
   (UNSPEC_DPSQ_S_W_PH		505)
   (UNSPEC_DPSQ_S_W_PH_64	506)
   (UNSPEC_DPSQ_W_QH		507)
   (UNSPEC_DPSQ_S_W_QH		508)
   (UNSPEC_MULSAQ_S_W_PH	509)
   (UNSPEC_MULSAQ_S_W_PH_64	510)
   (UNSPEC_MULSAQ_W_QH		511)
   (UNSPEC_MULSAQ_S_W_QH	512)
   (UNSPEC_MULSAQ_L_PW		513)
   (UNSPEC_MULSAQ_S_L_PW	514)
   (UNSPEC_DPAQ_SA_L_W		515)
   (UNSPEC_DPAQ_SA_L_W_64	516)
   (UNSPEC_DPAQ_L_PW		517)
   (UNSPEC_DPAQ_SA_L_PW		518)
   (UNSPEC_DPSQ_SA_L_W		519)
   (UNSPEC_DPSQ_SA_L_W_64	520)
   (UNSPEC_DPSQ_L_PW		521)
   (UNSPEC_DPSQ_SA_L_PW		522)
   (UNSPEC_MAQ_S_W_PHL		523)
   (UNSPEC_MAQ_S_W_PHR		524)
   (UNSPEC_MAQ_S_W_PHL_64	525)
   (UNSPEC_MAQ_S_W_PHR_64	526)
   (UNSPEC_MAQ_W_QHLL		527)
   (UNSPEC_MAQ_W_QHLR		528)
   (UNSPEC_MAQ_W_QHRL		529)
   (UNSPEC_MAQ_W_QHRR		530)
   (UNSPEC_MAQ_S_W_QHLL		531)
   (UNSPEC_MAQ_S_W_QHLR		532)
   (UNSPEC_MAQ_S_W_QHRL		533)
   (UNSPEC_MAQ_S_W_QHRR		534)
   (UNSPEC_MAQ_L_PWL		535)
   (UNSPEC_MAQ_L_PWR		536)
   (UNSPEC_MAQ_S_L_PWL		537)
   (UNSPEC_MAQ_S_L_PWR		538)
   (UNSPEC_MAQ_SA_W_PHL		539)
   (UNSPEC_MAQ_SA_W_PHR		540)
   (UNSPEC_MAQ_SA_W_PHL_64	541)
   (UNSPEC_MAQ_SA_W_PHR_64	542)
   (UNSPEC_DMADD		543)
   (UNSPEC_DMADDU		544)
   (UNSPEC_DMSUB		545)
   (UNSPEC_DMSUBU		546)
   ...
   (UNSPEC_REPL_QH		553)
   (UNSPEC_REPL_PW		554)
   (UNSPEC_CMPU_EQ_QB		555)
   (UNSPEC_CMPU_LT_QB		556)
   (UNSPEC_CMPU_LE_QB		557)
   (UNSPEC_CMPGU_EQ_QB		558)
   (UNSPEC_CMPGU_LT_QB		559)
   (UNSPEC_CMPGU_LE_QB		560)
   (UNSPEC_CMP_EQ_PH		561)
   (UNSPEC_CMP_LT_PH		562)
   (UNSPEC_CMP_LE_PH		563)
   (UNSPEC_CMPU_EQ_OB		564)
   (UNSPEC_CMPU_LT_OB		565)
   (UNSPEC_CMPU_LE_OB		566)
   (UNSPEC_CMP_EQ_QH		567)
   (UNSPEC_CMP_LT_QH		568)
   (UNSPEC_CMP_LE_QH		569)
   (UNSPEC_CMP_EQ_PW		570)
   (UNSPEC_CMP_LT_PW		571)
   (UNSPEC_CMP_LE_PW		572)
   (UNSPEC_PICK_QB		573)
   (UNSPEC_PICK_PH		574)
   (UNSPEC_PICK_OB		575)
   (UNSPEC_PICK_QH		576)
   (UNSPEC_PICK_PW		577)
   (UNSPEC_PACKRL_PH		578)
   (UNSPEC_EXTR_W		579)
   (UNSPEC_EXTR_R_W		580)
   (UNSPEC_EXTR_RS_W		581)
   (UNSPEC_EXTR_W_64		582)
   (UNSPEC_EXTR_R_W_64		583)
   (UNSPEC_EXTR_RS_W_64		584)
   (UNSPEC_DEXTR_W		585)
   (UNSPEC_DEXTR_R_W		586)
   (UNSPEC_DEXTR_RS_W		587)
   (UNSPEC_DEXTR_L		588)
   (UNSPEC_DEXTR_R_L		589)
   (UNSPEC_DEXTR_RS_L		590)
   (UNSPEC_EXTR_S_H		591)
   (UNSPEC_EXTR_S_H_64		592)
   (UNSPEC_DEXTL_W		593)
   (UNSPEC_DEXTL_S_W		594)
   (UNSPEC_DEXTL_L		595)
   (UNSPEC_DEXTL_S_L		596)
   (UNSPEC_EXTP			597)
   (UNSPEC_EXTPDP		598)
   (UNSPEC_EXTP_64		599)
   (UNSPEC_EXTPDP_64		600)
   (UNSPEC_DEXTP		601)
   (UNSPEC_DEXTPDP		602)
   (UNSPEC_SHILO		603)
   (UNSPEC_SHILO_64		604)
   (UNSPEC_DSHILO		605)
   (UNSPEC_MTHLIP		606)
   (UNSPEC_MTHLIP_64		607)
   (UNSPEC_DMTHLIP		608)
   (UNSPEC_WRDSP		609)
   (UNSPEC_RDDSP		610)

   ;; MIPS DSP ASE Rev2 Revision 0.02 12/12/2006
   (UNSPEC_ABSQ_S_QB		700)
   (UNSPEC_ADDU_PH		701)
   (UNSPEC_ADDU_S_PH		702)
   (UNSPEC_ADDUH_QB		703)
   (UNSPEC_ADDUH_R_QB		704)
   (UNSPEC_APPEND		705)
   (UNSPEC_BALIGN		706)
   (UNSPEC_CMPGDU_EQ_QB		707)
   (UNSPEC_CMPGDU_LT_QB		708)
   (UNSPEC_CMPGDU_LE_QB		709)
   (UNSPEC_DPA_W_PH		710)
   (UNSPEC_DPA_W_PH_64		711)
   (UNSPEC_DPS_W_PH		712)
   (UNSPEC_DPS_W_PH_64		713)
   (UNSPEC_MADD			714)
   (UNSPEC_MADDU		715)
   (UNSPEC_MSUB			716)
   (UNSPEC_MSUBU		717)
   (UNSPEC_MUL_PH		718)
   (UNSPEC_MUL_S_PH		719)
   (UNSPEC_MULQ_RS_W		720)
   (UNSPEC_MULQ_S_PH		721)
   (UNSPEC_MULQ_S_W		722)
   (UNSPEC_MULSA_W_PH		723)
   (UNSPEC_MULSA_W_PH_64	724)
   (UNSPEC_MULT			725)
   (UNSPEC_MULTU		726)
   (UNSPEC_PRECR_QB_PH		727)
   (UNSPEC_PRECR_SRA_PH_W	728)
   (UNSPEC_PRECR_SRA_R_PH_W	729)
   (UNSPEC_PREPEND		730)
   (UNSPEC_SHRA_QB		731)
   (UNSPEC_SHRA_R_QB		732)
   (UNSPEC_SHRL_PH		733)
   (UNSPEC_SUBU_PH		734)
   (UNSPEC_SUBU_S_PH		735)
   (UNSPEC_SUBUH_QB		736)
   (UNSPEC_SUBUH_R_QB		737)
   (UNSPEC_ADDQH_PH		738)
   (UNSPEC_ADDQH_R_PH		739)
   (UNSPEC_ADDQH_W		740)
   (UNSPEC_ADDQH_R_W		741)
   (UNSPEC_SUBQH_PH		742)
   (UNSPEC_SUBQH_R_PH		743)
   (UNSPEC_SUBQH_W		744)
   (UNSPEC_SUBQH_R_W		745)
   (UNSPEC_DPAX_W_PH		746)
   (UNSPEC_DPSX_W_PH		747)
   (UNSPEC_DPAQX_S_W_PH		748)
   (UNSPEC_DPAQX_SA_W_PH	749)
   (UNSPEC_DPSQX_S_W_PH		750)
   (UNSPEC_DPSQX_SA_W_PH	751)
   (UNSPEC_DPAX_W_PH_64         752)
   (UNSPEC_DPSX_W_PH_64         753)
   (UNSPEC_DPAQX_S_W_PH_64      754)
   (UNSPEC_DPAQX_SA_W_PH_64     755)
...
(define_attr "length" ""
   (cond [;; Direct branch instructions have a range of [-0x40000,0x3fffc].
	  ...
	  (cond [(eq (symbol_ref "TARGET_FIX_24K_E48") (const_int 0))
		 (symbol_ref "mips_fetch_insns (operands[0]) * 4")
		] (symbol_ref "mips_fetch_insns (operands[0]) * 4 + 4"))
...
(define_attr "cpu"
  "default,4kc,4kp,5kc,20kc,r24k,r24kx,r74k,r74kx,r74kz,r3000,r3900,r6000,r4000,r4100,r4111,r4120,r4300,r4600,r4650,r5000,r5400,r5500,r7000,r8000,r9000,sb1,sr71000"
...
(define_attr "hazard" "none,delay,hilo"
  (cond [(and (eq_attr "type" "load,fpload")
...
;; Can we use branch-likely instructions?
(define_attr "branch_likely" "no,yes,predict"
  (const (symbol_ref "mips_brlikely")))
...
(define_delay (and (eq_attr "type" "branch")
  ...
  [(eq_attr "can_delay" "yes")
   (nil)
   (and (eq_attr "can_delay" "yes")
	(ior (eq_attr "branch_likely" "yes")
	     (and (eq_attr "branch_likely" "predict")
		  (attr_flag "very_likely"))))])
...
(define_function_unit "memory"   1 0 (eq_attr "type" "store,fpstore") 1 0)

(define_function_unit "memory"   1 0 (eq_attr "type" "xfer") 2 0)

(define_function_unit "imuldiv"  1 0 (eq_attr "type" "mfhilo") 1 3)
(define_function_unit "imuldiv"  1 0 (eq_attr "type" "mthilo") 1 3)
...
(define_function_unit "imuldiv"  1 0
  (and (eq_attr "type" "imul,imul3,imadd") (eq_attr "cpu" "r3000,r3900"))
  12 12)

(define_function_unit "imuldiv"  1 0
  (and (eq_attr "type" "imul,imul3,imadd") (eq_attr "cpu" "r4000,r4600"))
  10 10)

(define_function_unit "imuldiv"  1 0
  (and (eq_attr "type" "imul,imul3,imadd") (eq_attr "cpu" "r4650"))
  4 4)
...
;; A special pattern to recognise an unextended three operand MIPS16
;; add-immediate, since we want to allow this when we can.
(define_insn "*addsi3_mips16_compact"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(plus:SI (match_operand:SI 1 "register_operand" "d")
		 (match_operand:SI 2 "m16_simm4_1" "O")))]
  "TARGET_MIPS16
...
(define_insn "*addsi2_mips16_compact"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(plus:SI (match_operand:SI 1 "register_operand" "0")
		 (match_operand:SI 2 "m16_simm8_1" "O")))]
  "TARGET_MIPS16
   && (REGNO (operands[0]) >= FIRST_PSEUDO_REGISTER
       || M16_REG_P (REGNO (operands[0])))
   && (REGNO (operands[1]) >= FIRST_PSEUDO_REGISTER
...
;; For MIPS16 we otherwise slightly disparage the three operand
;; add-immediate since the range of immediates available without an
;; extended instruction is smaller than for the two operand variant.
(define_insn "*addsi_mips16"
  [(set (match_operand:SI 0 "register_operand" "=d,d,d,*v,*d")
	(plus:SI (match_operand:SI 1 "register_operand" "0,?d,d,0,*v")
		 (match_operand:SI 2 "arith_operand" "Q,O,d,Q,Q")))]
  "TARGET_MIPS16
   && (GET_CODE (operands[1]) != REG
       || REGNO (operands[1]) >= FIRST_PSEUDO_REGISTER
       || M16_REG_P (REGNO (operands[1]))
   ...
   (set_attr_alternative "length"
		[(if_then_else (match_operand:VOID 2 "m16_simm8_1" "")
		 ...
		 (if_then_else (match_operand:VOID 2 "m16_simm4_1" "")
			       ...
			       (const_int 8))
		 (const_int 4)
		 (if_then_else (match_operand:VOID 2 "m16_simm8_8" "")
			       (const_int 4)
			       (const_int 8))
		 (if_then_else (match_operand:VOID 2 "m16_uimm8_4" "")
			       (const_int 4)
			       (const_int 8))])])
...
(define_insn ""
  [(set (match_operand:DI 0 "register_operand" "=d,d,d,*d")
	(plus:DI (match_operand:DI 1 "register_operand" "0,d,d,*v")
		 (match_operand:DI 2 "arith_operand" "Q,O,d,Q")))]
  "TARGET_MIPS16 && TARGET_64BIT
   && (GET_CODE (operands[1]) != REG
       || REGNO (operands[1]) >= FIRST_PSEUDO_REGISTER
       || M16_REG_P (REGNO (operands[1]))
   ...
   (set_attr_alternative "length"
		[(if_then_else (match_operand:VOID 2 "m16_simm5_1" "")
		 ...
		 (if_then_else (match_operand:VOID 2 "m16_simm4_1" "")
			       ...
			       (const_int 8))
		 (const_int 4)
		 (if_then_else (match_operand:VOID 1 "m16_uimm5_4" "")
			       (const_int 4)
			       (const_int 8))])])
...
(define_expand "mulsi3"
  ...
  ""
{
  if ((GENERATE_MULT3_SI && !TUNE_MIPS4KP) || TARGET_MAD)
...
(define_peephole2
  [(parallel
   ...
   (set (match_operand:SI 4 "register_operand" "")
        (match_dup 0))]
  "GENERATE_MULT3_SI && !TUNE_MIPS4KP
...
;; For MIPS 4Kp only.
;; Split a 3-operand MUL into a MULT/MFLO, since a MUL locks the whole
;; pipeline for 32 cycles and prevents us from doing any useful
...
(define_split
  ...
  "GENERATE_MULT3_SI && TUNE_MIPS4KP
   ...
   && true_regnum (operands[4]) == LO_REGNUM"
  [(parallel
       [(set (match_dup 4)
	     (mult:SI (match_dup 1)
		      (match_dup 2)))
...
;; For MIPS 4Kp only.
;; Final peephole to merge a consecutive MULT/MFLO, i.e. where we've
;; not been able to schedule anything between them, back into a MUL.
;; Matches mulsi3_internal pattern
(define_peephole
  [(parallel
       [(set (match_operand:SI 0 "register_operand" "")
	     (mult:SI (match_operand:SI 1 "register_operand" "")
...
;; Same but matches mulsi3_mult3 pattern
(define_peephole
  [(parallel
       [(set (match_operand:SI 0 "register_operand" "")
	     (mult:SI (match_operand:SI 1 "register_operand" "")
...
(define_insn "*mul_acc_si"
  [(set (match_operand:SI 0 "register_operand" "=????l,*d")
   ...
   (clobber (match_scratch:SI 6 "=X,&d"))]
  "ISA_HAS_MADD_MSUB && !TARGET_MIPS16"
  "@
   madd\t%1,%2
   #"
  [(set_attr "type"	"imadd,multi")
   (set_attr "mode"	"SI")
   (set_attr "length"	"4,8")])
...
(define_insn "mulsidi3_32bit"
  ...
  "!TARGET_MIPS_DSP32R2 && !TARGET_64BIT"
  "mult\t%1,%2"
  [(set_attr "type"	"imul")
   (set_attr "mode"	"SI")])
...
(define_insn "*smulsi3_highpart_ashift"
  [(set (match_operand:SI 0 "register_operand" "=h")
	(truncate:SI
	 (ashiftrt:DI
	  (mult:DI (sign_extend:DI (match_operand:SI 1 "register_operand" "d"))
  ...
  [(set (match_operand:DI 0 "register_operand" "=x")
	(plus:DI
	 (mult:DI (zero_extend:DI (match_operand:SI 1 "register_operand" "d"))
		  (zero_extend:DI (match_operand:SI 2 "register_operand" "d")))
	 (match_operand:DI 3 "register_operand" "0")))]
  "!TARGET_MIPS_DSP32R2 && (TARGET_MAD || ISA_HAS_MACC || ISA_HAS_MADD_MSUB)
   && !TARGET_64BIT"
{
  if (TARGET_MAD)
    return "madu\t%1,%2";
  else if (TARGET_MIPS5500 || ISA_HAS_MADD_MSUB)
    return "maddu\t%1,%2";
  else
    return "maccu\t%.,%1,%2";
}
...
(define_insn "absdi2"
  ...
  "TARGET_64BIT && !TARGET_MIPS16 && BRANCH_COST < 2"
{
  unsigned int regno1;
  operands[2] = const0_rtx;
...
(define_expand "ctzsi2"
  ...
  "
  {
    ...
    emit_insn (gen_andsi3 (t2, operands[1], t1));
    emit_insn (gen_clzsi2 (t3, t2));
    emit_insn (gen_xorsi3 (operands[0], t3, GEN_INT (31)));
    DONE;
  }"
)
...
(define_expand "ffsdi2"
  ...
  "
  {
    ...
    t4 = gen_reg_rtx (DImode);

    emit_insn (gen_negdi2 (t1, operands[1]));
    emit_insn (gen_anddi3 (t2, operands[1], t1));
    emit_insn (gen_clzdi2 (t3, t2));
    emit_move_insn (t4, GEN_INT (64));
    emit_insn (gen_subdi3 (operands[0], t4, t3));
    DONE;
  }"
)
...
(define_expand "ctzdi2"
  ...
  "
  {
    ...
    emit_insn (gen_anddi3 (t2, operands[1], t1));
    emit_insn (gen_clzdi2 (t3, t2));
    emit_insn (gen_xordi3 (operands[0], t3, GEN_INT (63)));
    DONE;
  }"
)

...
(define_insn ""
  [(set (match_operand:SI 0 "register_operand" "=d")
        (truncate:SI (match_operand:DI 1 "register_operand" "0")))]
  "TARGET_64BIT && TARGET_MIPS16E"
  "sew\t%0"
  [(set_attr "type" "darith")
   (set_attr "mode" "SI")])
...
(define_expand "truncdihi2"
  [(set (match_operand:HI 0 "nonimmediate_operand" "")
        (truncate:HI (match_operand:DI 1 "register_operand" "")))]
  "TARGET_64BIT"
  "")
...
(define_insn ""
  [(set (match_operand:HI 0 "register_operand" "=d")
        (truncate:HI (match_operand:DI 1 "register_operand" "0")))]
  "TARGET_64BIT && TARGET_MIPS16E"
  "sew\t%0"
  [(set_attr "type" "darith")
   (set_attr "mode" "SI")])
...
(define_expand "truncdiqi2"
  [(set (match_operand:QI 0 "nonimmediate_operand" "")
        (truncate:QI (match_operand:DI 1 "register_operand" "")))]
  "TARGET_64BIT"
  "")
...
(define_insn ""
  [(set (match_operand:QI 0 "register_operand" "=d")
        (truncate:QI (match_operand:DI 1 "register_operand" "0")))]
  "TARGET_64BIT && TARGET_MIPS16E"
  "sew\t%0"
  [(set_attr "type" "darith")
   (set_attr "mode" "SI")])
...
(define_insn_and_split ""
  [(set (match_operand:SI 0 "register_operand" "=d")
	(sign_extend:SI
	    (truncate:HI (match_operand:DI 1 "register_operand" "d"))))]
  "TARGET_64BIT && !ISA_HAS_SEB_SEH && !TARGET_MIPS16"
  "#"
  "&& reload_completed"
  [(set (match_dup 2)
...
(define_expand "zero_extendsidi2"
  ...
  "
{
    if (!TARGET_MIPS16E && !ISA_HAS_INSV)
    {
...
(define_insn ""
  [(set (match_operand:DI 0 "register_operand" "=d")
        (zero_extend:DI (match_operand:SI 1 "register_operand" "0")))]
  "TARGET_64BIT && ISA_HAS_INSV && !TARGET_MIPS16"
  "dins\t%0,$0,32,32"
  [(set_attr "type"     "darith")
   (set_attr "mode"     "DI")])
...
(define_expand "zero_extendhisi2"
  ...
  ""
{
  if (TARGET_MIPS16 && !TARGET_MIPS16E && GET_CODE (operands[1]) != MEM)
    {
...
(define_insn "extendsidi2_mips16e"
  [(set (match_operand:DI 0 "register_operand" "=d")
...
(define_insn "*extendhidi2"
  ...
  "TARGET_64BIT && !ISA_HAS_SEB_SEH && !TARGET_MIPS16E"
  "#")

(define_split
  [(set (match_operand:DI 0 "register_operand" "")
        (sign_extend:DI (match_operand:HI 1 "register_operand" "")))]
  "TARGET_64BIT && !ISA_HAS_SEB_SEH && !TARGET_MIPS16E && reload_completed"
  [(set (match_dup 0)
...
(define_insn "extendhidi2_hw"
  [(set (match_operand:DI 0 "register_operand" "=d")
        (sign_extend:DI (match_operand:HI 1 "register_operand" "d")))]
  "TARGET_64BIT && ISA_HAS_SEB_SEH"
  "seh\t%0,%1"
  [(set_attr "type"     "signext")
   (set_attr "mode"     "DI")])

(define_insn "extendhidi2_mips16e"
  [(set (match_operand:DI 0 "register_operand" "=d")
        (sign_extend:DI (match_operand:HI 1 "register_operand" "0")))]
  "TARGET_64BIT && TARGET_MIPS16E"
  "seh\t%0"
  [(set_attr "type"     "signext")
   (set_attr "mode"     "DI")])
...
(define_insn "*extendhisi2"
  ...
  "!ISA_HAS_SEB_SEH && !TARGET_MIPS16E"
  "#")

(define_split
  [(set (match_operand:SI 0 "register_operand" "")
        (sign_extend:SI (match_operand:HI 1 "register_operand" "")))]
  "!ISA_HAS_SEB_SEH && !TARGET_MIPS16E && reload_completed"
  [(set (match_dup 0)
...
(define_insn "extendhisi2_mips16e"
  [(set (match_operand:SI 0 "register_operand" "=d")
...
(define_insn "extendqisi2_mips16e"
  [(set (match_operand:SI 0 "register_operand" "=d")
...
(define_insn "extendqidi2_mips16e"
  [(set (match_operand:DI 0 "register_operand" "=d")
        (sign_extend:DI (match_operand:QI 1 "register_operand" "0")))]
  "TARGET_64BIT && TARGET_MIPS16E"
  "seb\t%0"
  [(set_attr "type"     "signext")
   (set_attr "mode"     "DI")])
...
(define_insn "movdi_internal"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=d,d ,d,m,*x*a,*d  ,*x*a,*B*C*D,*B*C*D,    *d,    *m")
	(match_operand:DI 1 "general_operand"      " d,iF,m,d,J   ,*x*a,*d  ,*d    ,    *m,*B*C*D,*B*C*D"))]
  ...
  [(set_attr "type"	"move,arith,load,store,mthilo,mfhilo,mthilo,xfer,load,xfer,store")
   (set_attr "mode"	"DI")
   (set_attr "length"   "8,16,*,*,8,8,8,8,*,8,*")])

;; mips32r2 optionally supports a full 64-bit fpu
(define_insn "movdi_internal_mips32r2"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=d,d ,d,m, *f,*f,  *f,*d,*m,*x*a,*d  ,*x*a")
	(match_operand:DI 1 "general_operand"      " d,iF,m,dJ,*f,*d*J,*m,*f,*f,*J  ,*x*a,*d"))]
  "!TARGET_64BIT && TARGET_FLOAT64 && !TARGET_MIPS16
   && (register_operand (operands[0], DImode)
       || register_operand (operands[1], DImode)
       || (GET_CODE (operands[1]) == CONST_INT && INTVAL (operands[1]) == 0)
       || operands[1] == CONST0_RTX (DImode))"
  { return mips_output_move (operands[0], operands[1]); }
  [(set_attr "type"	"move,arith,load,store,move,xfer,fpload,xfer,fpstore,mthilo,mfhilo,mthilo")
   (set_attr "mode"	"DI")
   (set_attr "cnv_mode"	"*,*,*,*,*,I2D,*,F2I,*,*,*,*")
   (set_attr "length"	"8,16,*,*,4,8,*,8,*,8,8,8")])
...
(define_insn "movdi_internal2"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=d,d,e,d,m, *f,*f,  *f,*d,*m,*x*a,*d  ,*x*a,*B*C*D,*B*C*D,*d,    *m")
	(match_operand:DI 1 "move_operand"         " d,U,T,m,dJ,*f,*d*J,*m,*f,*f,*J  ,*x*a,*d  ,*d,    *m,    *B*C*D,*B*C*D"))]
  "TARGET_64BIT && !TARGET_MIPS16
   && (register_operand (operands[0], DImode)
       || register_operand (operands[1], DImode)
       || (GET_CODE (operands[1]) == CONST_INT && INTVAL (operands[1]) == 0)
       || operands[1] == CONST0_RTX (DImode))"
  { return mips_output_move (operands[0], operands[1]); }
  [(set_attr "type"	"move,const,const,load,store,move,xfer,fpload,xfer,fpstore,mthilo,mfhilo,mthilo,xfer,load,xfer,store")
   (set_attr "mode"	"DI")
   (set_attr "cnv_mode"	"*,*,*,*,*,*,I2D,*,F2I,*,*,*,*,*,*,*,*")
...
(define_insn "*movdi_internal2_mips16"
  ...
  "TARGET_64BIT && TARGET_MIPS16
   && (register_operand (operands[0], DImode)
       || register_operand (operands[1], DImode))"
  { return mips_output_move (operands[0], operands[1]); }
  [(set_attr "type"	"move,move,move,arith,arith,const,load,store,mfhilo")
   (set_attr "mode"	"DI")
   (set_attr_alternative "length"
		[(const_int 4)
		 (const_int 4)
...
(define_insn "movsi_internal"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=d,d,e,d,m, *f,*f,  *f,*d,*m,*d,*z,*x*a,*d  ,*x*a,*B*C*D,*B*C*D,*d,    *m")
	(match_operand:SI 1 "move_operand"         " d,U,T,m,dJ,*f,*d*J,*m,*f,*f,*z,*d,J   ,*x*a,*d  ,*d,    *m,    *B*C*D,*B*C*D"))]
  "!TARGET_MIPS16
   && (register_operand (operands[0], SImode)
       || register_operand (operands[1], SImode)
       || (GET_CODE (operands[1]) == CONST_INT && INTVAL (operands[1]) == 0))"
  { return mips_output_move (operands[0], operands[1]); }
  [(set_attr "type"	"move,const,const,load,store,move,xfer,fpload,xfer,fpstore,xfer,xfer,mthilo,mfhilo,mthilo,xfer,load,xfer,store")
   (set_attr "mode"	"SI")
...
;; On SmartMIPS support scaled indexed address, but only for
;; 32-bit loads, and not stores or any other data size.

(define_insn "lwx_mult2"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(mem:SI (plus:SI (match_operand:SI 1 "register_operand" "d")
			 (mult:SI (match_operand:SI 2 "register_operand" "d")
				  (const_int 4)))))]
  "TARGET_SMARTMIPS && !TARGET_MIPS16"
  "lwxs\t%0,%2(%1)"
  [(set_attr "type"	"load")
   (set_attr "mode"	"SI")
   (set_attr "length"   "4")])

(define_insn "lwx_mult1"
  [(set (match_operand:SI 0 "register_operand" "=d")
...
(define_insn "lwx_shift2"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(mem:SI (plus:SI (match_operand:SI 1 "register_operand" "d")
			 (ashift:SI (match_operand:SI 2 "register_operand" "d")
				    (const_int 2)))))]
  "TARGET_SMARTMIPS && !TARGET_MIPS16"
  "lwxs\t%0,%2(%1)"
  [(set_attr "type"	"load")
...
(define_insn "lwx_shift1"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(mem:SI (plus:SI (ashift:SI (match_operand:SI 1 "register_operand" "d")
				    (const_int 2))
			 (match_operand:SI 2 "register_operand" "d"))))]
  "TARGET_SMARTMIPS && !TARGET_MIPS16"
  "lwxs\t%0,%1(%2)"
...
(define_insn "movhi_internal"
  [(set (match_operand:HI 0 "nonimmediate_operand" "=d,d,d,m,*d,*f,*f,*x,*d,*a,*d")
	(match_operand:HI 1 "general_operand"       "d,IK,m,dJ,*f,*d,*f,*d,*x,*d,*a"))]
  "!TARGET_MIPS16
   && (register_operand (operands[0], HImode)
       || register_operand (operands[1], HImode)
       || (GET_CODE (operands[1]) == CONST_INT && INTVAL (operands[1]) == 0))"
  "@
    ...
    mtlo\t%z1,%q0
    mflo\t%0,%q1"
  [(set_attr "type"	"move,arith,load,store,xfer,xfer,move,mthilo,mfhilo,mthilo,mfhilo")
   (set_attr "mode"	"HI")
   (set_attr "cnv_mode"	"*,*,*,*,F2I,I2S,*,*,*,*,*")
...
(define_insn "movqi_internal"
  [(set (match_operand:QI 0 "nonimmediate_operand" "=d,d,d,m,*d,*f,*f,*x,*d,*a,*d")
	(match_operand:QI 1 "general_operand"       "d,IK,m,dJ,*f,*d,*f,*d,*x,*d,*a"))]
  "!TARGET_MIPS16
   && (register_operand (operands[0], QImode)
       || register_operand (operands[1], QImode)
       || (GET_CODE (operands[1]) == CONST_INT && INTVAL (operands[1]) == 0))"
...
(define_expand "movsf"
  ...
  ""
{
  if ((reload_in_progress | reload_completed) == 0 && TARGET_MIPS16 
      && mips_legitimize_move (SFmode, operands[0], operands[1]))
    DONE;
...
{
  if ((reload_in_progress | reload_completed) == 0 && TARGET_MIPS16 && 
      mips_legitimize_move (DFmode, operands[0], operands[1]))
    DONE;
...
(define_insn "movdf_internal1b"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=f,f,f,m,*f,*d,*d,*d,*m")
	(match_operand:DF 1 "general_operand" "f,G,m,fG,*d,*f,*d*G,*m,*d"))]
  "TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT && !TARGET_64BIT && !TARGET_FLOAT64
   && (register_operand (operands[0], DFmode)
       || nonmemory_operand (operands[1], DFmode))"
  { return mips_output_move (operands[0], operands[1]); }
  [(set_attr "type"	"move,xfer,fpload,fpstore,xfer,xfer,move,load,store")
...
;; mips32r2 optionally supports a full 64-bit fpu
(define_insn "movdf_internal1b_mips32r2"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=f,f,f,m, *f,*d,*d,  *d,*m")
	(match_operand:DF 1 "general_operand"      " f,G,m,fG,*d,*f,*d*G,*m,*d"))]
  "TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT && !TARGET_64BIT && TARGET_FLOAT64
   && (register_operand (operands[0], DFmode)
...
(define_split
  ...
  "reload_completed && !TARGET_64BIT && TARGET_PAIRED_SINGLE_FLOAT
   && mips_split_64bit_move_p (operands[0], operands[1])"
  [(const_int 0)]
{
  mips_split_64bit_move (operands[0], operands[1]);
...
(define_insn "load_df_high"
  [(set (match_operand 0 "register_operand" "=f,f")
	(unspec [(match_operand:SI 1 "general_operand" "dJ,m")
		 (match_operand 2 "register_operand" "0,0")]
		UNSPEC_LOAD_DF_HIGH))]
  "TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT && !TARGET_64BIT"
{
...
(define_insn "store_df_high"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=d,m")
	(unspec:SI [(match_operand 1 "register_operand" "f,f")]
...
(define_insn "mthc1"
  [(set (match_operand 0 "register_operand" "=f")
	(unspec [(match_operand:SI 1 "general_operand" "dJ")
		...
		UNSPEC_MTHC1))]
  "TARGET_HARD_FLOAT && TARGET_FLOAT64 && !TARGET_64BIT && ISA_HAS_MXHC1"
  "mthc1\t%z1,%0"
  [(set_attr "type"	"xfer")
   (set_attr "mode"	"SF")
   (set_attr "cnv_mode"	"I2D")
...
(define_insn_and_split "ashlsi3_internal1"
  [(set (match_operand:SI 0 "register_operand" "=d,d")
  ...
  "!TARGET_MIPS16"
{
  ...
  [(set (match_dup 0) (match_dup 1))]
  ""
  [(set_attr "type"	"vshift,shift")
   (set_attr "mode"	"SI")])

(define_insn "ashlsi3_internal1_extend"
  [(set (match_operand:DI 0 "register_operand" "=d,d")
       (sign_extend:DI (ashift:SI (match_operand:SI 1 "register_operand" "d,d")
                                  (match_operand:SI 2 "arith_operand" "d,I"))))]
  "TARGET_64BIT && !TARGET_MIPS16"
{
  if (GET_CODE (operands[2]) == CONST_INT)
...
;; XXX Would be better done using define_expand, so it can be optimised
...
(define_insn_and_split "ashrsi3_internal1"
  [(set (match_operand:SI 0 "register_operand" "=d,d")
...
{
  if (GET_CODE (operands[2]) == CONST_INT)
    emit_insn (gen_rotrsi3 (operands[0], operands[1], 
			    GEN_INT (32 - INTVAL (operands[2]))));
  else
  {  
    emit_insn (gen_negsi2 (operands[0], operands[2]));
    emit_insn (gen_rotrsi3 (operands[0], operands[1], operands[0]));
  }
  DONE;
})
  ...
  "ISA_HAS_ROTR_DI"
{
  if (GET_CODE (operands[2]) == CONST_INT)
    emit_insn (gen_rotrsi3 (operands[0], operands[1], 
			    GEN_INT (64 - INTVAL (operands[2]))));
  else
  {    
    emit_insn (gen_negdi2 (operands[0], operands[2]));
    emit_insn (gen_rotrdi3 (operands[0], operands[1], operands[0]));
  }
  DONE;
})
...
(define_insn "jump"
  ...
  if (flag_pic && ! TARGET_EMBEDDED_PIC)
    ...
    {
      /* Prefer branch when in range. */
      if (INSN_ADDRESSES_SET_P () &&
          abs (INSN_ADDRESSES (INSN_UID (JUMP_LABEL (insn)))
	       - (insn_current_reference_address (insn) + 4)) < 131072)
	return "%*b\t%l0%/";
      else
        return "%*j\t%l0%/";
    }
...
(define_insn "prefetch_indexed_si"
  [(prefetch (plus:SI (match_operand:SI 0 "register_operand" "r")
	     ...
	     (match_operand:SI 1 "const_int_operand" "n")
	     (match_operand:SI 2 "const_int_operand" "n"))]
  "ISA_HAS_PREFETCHX && TARGET_HARD_FLOAT && TARGET_FLOAT64 && Pmode == SImode"
  { return mips_emit_prefetch (operands); }
...
(define_insn "prefetch_indexed_di"
  [(prefetch (plus:DI (match_operand:DI 0 "register_operand" "r")
	     ...
	     (match_operand:DI 1 "const_int_operand" "n")
	     (match_operand:DI 2 "const_int_operand" "n"))]
  "ISA_HAS_PREFETCHX && TARGET_HARD_FLOAT && TARGET_FLOAT64 && Pmode == DImode"
  { return mips_emit_prefetch (operands); }
  [(set_attr "type" "prefetchx")])
...
;	(if_then_else:DI
;	 (match_operator 4 "equality_op"
;			 [(match_operand:SI 1 "register_operand" "d,d,d,d")
;			  (const_int 0)])
;	 (match_operand:DI 2 "reg_or_0_operand" "d,J,0,0")
;	 (match_operand:DI 3 "reg_or_0_operand" "0,0,d,J")))]
;  "(ISA_HAS_CONDMOVE || ISA_HAS_INT_CONDMOVE) && !TARGET_64BIT"
;  "@
;    mov%B4\t%L0,%L2,%1;mov%B4\t%M0,%M2,%1
;    mov%B4\t%L0,%.,%1;mov%B4\t%M0,%.,%1
;    mov%b4\t%L0,%L3,%1;mov%b4\t%M0,%M3,%1
;    mov%b4\t%L0,%.,%1;mov%b4\t%M0,%.,%1"
;  "(ISA_HAS_CONDMOVE || ISA_HAS_INT_CONDMOVE) && !TARGET_64BIT"
;  [(set (subreg:SI (match_dup 0) 0)
;	(if_then_else:SI
;	 (match_op_dup 4 [(match_dup 1)
;			  (const_int 0)])
;	 (subreg:SI (match_dup 2) 0)
...
;							    "z,z,z,z")
;					  (const_int 0)])
;	 (match_operand:DI 1 "reg_or_0_operand" "d,J,0,0")
;	 (match_operand:DI 2 "reg_or_0_operand" "0,0,d,J")))]
;  "ISA_HAS_CONDMOVE && TARGET_HARD_FLOAT && !TARGET_64BIT"
;  "@
;    mov%T3\t%L0,%L1,%4;mov%T3\t%M0,%M1,%4
;    mov%T3\t%L0,%.,%4;mov%T3\t%M0,%.,%4
;    mov%t3\t%L0,%L2,%4;mov%t3\t%M0,%M2,%4
;    mov%t3\t%L0,%.,%4;mov%t3\t%M0,%.,%4"
;  "ISA_HAS_CONDMOVE && TARGET_HARD_FLOAT && !TARGET_64BIT"
;  [(set (subreg:SI (match_dup 0) 0)
;	(if_then_else:SI
...
;; ---------------------------------------------------------------------------
;;
;; MIPS paired single instructions
;;
;; ---------------------------------------------------------------------------
  ...
  "TARGET_PAIRED_SINGLE_FLOAT"
{
  if ((reload_in_progress | reload_completed) == 0
      ...
      && !nonmemory_operand (operands[1], V2SFmode))
    operands[1] = force_reg (V2SFmode, operands[1]);
})

(define_insn "movv2sf_internal1a"
  [(set (match_operand:V2SF 0 "nonimmediate_operand" "=f,f,f,m,m,*f,*d,*d,  *d,*m")
        (match_operand:V2SF 1 "general_operand"      " f,Y,m,f,Y,*d,*f,*d*Y,*m,*d"))]
  "TARGET_PAIRED_SINGLE_FLOAT
   && TARGET_64BIT
   && (register_operand (operands[0], V2SFmode)
       || reg_or_0_operand (operands[1], V2SFmode))"
{ return mips_output_move (operands[0], operands[1]); }
  [(set_attr "type"	"move,xfer,fpload,fpstore,store,xfer,xfer,move,load,store")
   (set_attr "mode"	"SF")
   (set_attr "length"	"4,4,*,*,*,4,4,4,*,*")])

(define_insn "movv2sf_internal1b"
  [(set (match_operand:V2SF 0 "nonimmediate_operand" "=f,f,f,m,m,*f,*d,*d,  *d,*m")
        (match_operand:V2SF 1 "general_operand"      " f,Y,m,f,Y,*d,*f,*d*Y,*m,*d"))]
"TARGET_PAIRED_SINGLE_FLOAT
 && !TARGET_64BIT
...
(define_expand "movv2sfcc"
  ...
  "TARGET_PAIRED_SINGLE_FLOAT"
{
  /* We can only support movn.ps and movz.ps here.
     For movt.ps and movf.ps, we need to use builtin functions. 
     NOTE: movt.ps and movf.ps depend on two CC values, and move two single
  ...
  "TARGET_PAIRED_SINGLE_FLOAT"
{
  ...
  if (BYTES_BIG_ENDIAN)
    emit_insn (gen_mips_cvt_ps_s (operands[0], op0, op1));
  else
    emit_insn (gen_mips_cvt_ps_s (operands[0], op1, op0));
  DONE;
})
...
(define_insn "bc1any4t"
  [(set (pc)
        (if_then_else 
           (eq:CCV4 (match_operand:CCV4 1 "register_operand" "z") (const_int 0))
           (label_ref (match_operand 0 "" ""))
           (pc))
        )]
  "TARGET_MIPS3D"
...
(define_insn "bc1any4f"
  [(set (pc)
        (if_then_else 
           (ne:CCV4 (match_operand:CCV4 1 "register_operand" "z") (const_int 1))
           (label_ref (match_operand 0 "" ""))
           (pc))
        )]
  "TARGET_MIPS3D"
...
(define_insn "bc1any2t"
  [(set (pc)
        (if_then_else 
           (eq:CCV2 (match_operand:CCV2 1 "register_operand" "z") (const_int 0))
           (label_ref (match_operand 0 "" ""))
           (pc))
        )]
  "TARGET_MIPS3D"
...
(define_insn "bc1upper2t"
  [(set (pc)
        (if_then_else 
           (eq:CCV2 (match_operand:CCV2 1 "register_operand" "z") (const_int 1))
           (label_ref (match_operand 0 "" ""))
           (pc))
        )]
  "TARGET_PAIRED_SINGLE_FLOAT"
...
(define_insn "bc1lower2t"
  [(set (pc)
        (if_then_else 
           (eq:CCV2 (match_operand:CCV2 1 "register_operand" "z") (const_int 2))
           (label_ref (match_operand 0 "" ""))
           (pc))
        )]
  "TARGET_PAIRED_SINGLE_FLOAT"
...
(define_insn "bc1any2f"
  [(set (pc)
        (if_then_else 
           (ne:CCV2 (match_operand:CCV2 1 "register_operand" "z") (const_int 3))
           (label_ref (match_operand 0 "" ""))
           (pc))
        )]
  "TARGET_MIPS3D"
...
(define_insn "bc1upper2f"
  [(set (pc)
        (if_then_else 
           (ne:CCV2 (match_operand:CCV2 1 "register_operand" "z") (const_int 1))
           (label_ref (match_operand 0 "" ""))
           (pc))
        )]
  "TARGET_PAIRED_SINGLE_FLOAT"
...
(define_insn "bc1lower2f"
  [(set (pc)
        (if_then_else 
           (ne:CCV2 (match_operand:CCV2 1 "register_operand" "z") (const_int 2))
           (label_ref (match_operand 0 "" ""))
           (pc))
        )]
  "TARGET_PAIRED_SINGLE_FLOAT"
...
; MIPS16E
;----------------------------------------------------------------------------
(define_insn "save_mips16e"
  [(set (reg:SI 29) (unspec_volatile:SI [(reg:SI 29)
				(match_operand:SI 0 "immediate_operand" "")]
			       UNSPEC_SAVE_MIPS16E))]
  "TARGET_MIPS16E"
  "* return mips16e_output_save (operands);"
  [(set_attr "type"	"arith")
   (set_attr "length"	"8")
   (set_attr "mode"	"SI")])

(define_insn "restore_mips16e"
  [(set (reg:SI 29) (unspec_volatile:SI [(reg:SI 29)
				(match_operand:SI 0 "immediate_operand" "")]
			       UNSPEC_RESTORE_MIPS16E))]
  "TARGET_MIPS16E"
  "* return mips16e_output_restore (operands);"
  [(set_attr "type"	"arith")
   (set_attr "length"	"8")
   (set_attr "mode"	"SI")])

;----------------------------------------------------------------------------
; The MIPS DSP ASE to the MIPS32 and MIPS64 Architecture
;----------------------------------------------------------------------------
(include "mips-dsp.md")
(include "mips-dspr2.md")

;; This pattern supports loading HIGH addresses with two instructions instead
;; of using the macro instruction lui.
(define_insn "high_mips16"
  [(set (match_operand:SI 0 "register_operand" "=d")
...
;; Convert mtlo $0 mthi $0 to mult $0, $0
(define_peephole2
  [(set (match_operand:SI 0 "register_operand" "")
	(const_int 0))
   (set (match_operand:SI 1 "register_operand" "")
	(const_int 0))]
  "!TARGET_MIPS16 && !TARGET_64BIT && (TUNE_MIPS24K || TUNE_MIPS24KX) &&
   ((true_regnum (operands[0]) == LO_REGNUM && 
     true_regnum (operands[1]) == HI_REGNUM) ||
    (true_regnum (operands[0]) == HI_REGNUM && 
     true_regnum (operands[1]) == LO_REGNUM))"
...
(define_insn ""
  [(parallel [(set (match_operand:SI 0 "register_operand" "=l")
	      (const_int 0))
	      (set (match_operand:SI 1 "register_operand" "=h")
	      (const_int 0))])]
  "!TARGET_MIPS16 && !TARGET_64BIT && (TUNE_MIPS24K || TUNE_MIPS24KX)"
...
;; HACK: crudely merges 2 consecutive prefetches if they lie within 32bytes
;; of each other.
(define_peephole2
  [(prefetch (plus:SI (match_operand:SI 0 "register_operand" "")
		      (match_operand:SI 1 "const_int_operand" ""))
	     (match_operand:SI 2 "const_int_operand" "")
	     (match_operand:SI 3 "const_int_operand" ""))
   (prefetch (plus:SI (match_operand:SI 4 "register_operand" "")
		      (match_operand:SI 5 "const_int_operand" ""))
	     (match_operand:SI 6 "const_int_operand" "")
	     (match_operand:SI 7 "const_int_operand" ""))]
  "REGNO (operands[0]) == REGNO (operands[4])
   && INTVAL (operands[2]) == INTVAL (operands[6])
   && INTVAL (operands[3]) == INTVAL (operands[7])
   && INTVAL (operands[5]) / 32 == INTVAL (operands[1]) / 32"
  [(prefetch (plus:SI (match_dup 0) (match_dup 1))
	     (match_dup 2)
	     (match_dup 3))]
)
