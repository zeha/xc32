...
#define TARGET_SCHED_REGNO_CLOBBER_DEPENDENCIES 0
...
#define TARGET_SCHED						\
  {TARGET_SCHED_ADJUST_COST,					\
   ...
   TARGET_SCHED_REGNO_CLOBBER_DEPENDENCIES}
...
#define TARGET_PREPARE_FUNCTION_START default_prepare_function_start
#endif
...
#define TARGET_WEB_MARK_REGISTER 0

#define TARGET_SPILL_AUTO_REGISTER 0
...
{						\
  ...
  TARGET_PCH_VALID_P,				\
  TARGET_WEB_MARK_REGISTER,			\
  TARGET_SPILL_AUTO_REGISTER,			\
  TARGET_CALLS,					\
