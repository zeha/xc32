...
bool
decl_data_section (tree decl, int reloc)
{
  return decl_data_section_1 (decl, reloc, flag_pic);
}

bool
decl_data_section_1 (tree decl, int reloc, int shlib)
{
  switch (categorize_decl_for_section (decl, reloc, shlib))
    {
    case SECCAT_DATA:
...
bool
decl_bss_section (tree decl, int reloc)
{
  return decl_bss_section_1 (decl, reloc, flag_pic);
}

bool
decl_bss_section_1 (tree decl, int reloc, int shlib)
{
  switch (categorize_decl_for_section (decl, reloc, shlib))
    {
    case SECCAT_BSS:
