  ...
  if (GET_CODE (dest) == REG)
    {
      ...
      /* Check whether to treat the current register with only clobber 
	 dependencies.  */
      if (targetm.sched.regno_clobber_dependencies
	  && (*targetm.sched.regno_clobber_dependencies) (regno))
