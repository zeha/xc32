...
/* Set if this symbol is a section-relative symbol  */
#define SYMBOL_FLAG_SECTION_RELATIVE	(1 << 7)
#define SYMBOL_REF_SECTION_RELATIVE_P(RTX) \
  ((SYMBOL_REF_FLAGS (RTX) & SYMBOL_FLAG_SECTION_RELATIVE) != 0)

/* Subsequent bits are available for the target to use.  */
#define SYMBOL_FLAG_MACH_DEP_SHIFT	8
