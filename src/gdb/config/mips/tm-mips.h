...
#define ZERO_REGNUM	0	/* read-only rbegister, always 0 */
#define V0_REGNUM	2	/* Function integer return value */
#define A0_REGNUM	4	/* Loc of first arg during a subr call */
#define S2_REGNUM	18	/* Contains return address in mips16 thunks */
#define T9_REGNUM	25	/* Contains address of callee in PIC */
#define RA_REGNUM	31	/* Contains return address value */
#define PS_REGNUM	32	/* Contains processor status */
#define UNUSED_REGNUM	73	/* Never used, FIXME */
#define FIRST_EMBED_REGNUM 83	/* First CP0 register for embedded use */
#define CP0_REGNUM	83	/* First CP0 data register: 8 banks of 32 registers*/
#define PRID_REGNUM	(CP0_REGNUM+15)	/* Processor ID */
#define CP2_REGNUM	339	/* 83+8*32: First CP2 data register: 8 banks of 32 registers */
#define CP2CTL_REGNUM	595	/* 339+8*32: First CP2 control register: 32 registers */
#define DSPACC_REGNUM	627	/* 595+32: DSP/SmartMIPS ACX,Hi1,Lo1,ACX1,Hi2,Lo2,ACX2,Hi3,Lo3,ACX3 */
#define DSPCTL_REGNUM	637	/* 627+10: DSP DSPCTL0..1 registers */
#define PAD_REGNUM	639	/* 637+2: Unused register to make total number of registers even */
#define LAST_EMBED_REGNUM 639	/* Last one */
...
#define GDB_TARGET_START_REMOTE() \
