...
M::enum return_value_convention:return_value:struct value *function, struct regcache *regcache, void *readbuf, const void *writebuf:function, regcache, readbuf, writebuf::legacy_return_value
