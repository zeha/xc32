...
/* MERGE_TODO: update configure to pass _BUILD_MCHP_ to this library */
/* PIC32C: we want the semihosting functions defined here to be non-weak so
   that they may replace the libpic32c.a stubs. */
...
/* PIC32C target does not support this implementation. _sbrk is provided
   in libpic32c.a/ */
void * __weakstub__
