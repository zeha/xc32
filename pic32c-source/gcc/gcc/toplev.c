...
compile_file (void)
{
  ...
  extern void mchp_output_vector_dispatch_table (void);
  extern void mchp_output_ext_region_memory_info (void);
...
output_stack_usage (void)
{
  ...
  if (mchp_stack_usage)
    {
      void xc_output_stack_usage (HOST_WIDE_INT, int);
      xc_output_stack_usage (stack_usage, stack_usage_kind);
    }
#endif
