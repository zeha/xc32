...
extern void mchp_asm_output_labelref (FILE *stream, const char *name);
extern bool mchp_attribute_takes_identifier_p (const_tree attr_id);
...
extern void mchp_cache_conversion_state(const_rtx, tree);
extern rtx  pic32_expand_software_reset_libcall(void);

/* Code Coverage related */
extern void pic32_begin_cc_instrument (void);
extern rtx_insn* pic32_adjust_insert_pos (basic_block bb, int prologue_bb, rtx_insn *where);
...
extern void pic32_emit_su_section (const char *name);
