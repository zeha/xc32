/**
 * \brief Component description for PIC32CZ/CA70 QSPI
 *
...
#ifndef _PIC32CZ_CA70_QSPI_COMPONENT_H_
#define _PIC32CZ_CA70_QSPI_COMPONENT_H_

/** \addtogroup PIC32CZ_CA70_QSPI Quad Serial Peripheral Interface
 *  @{
 */
/* ========================================================================== */
...
typedef struct
{
  __O   __QSPI_CR_bits_t               QSPI_CR;       /**< Offset: 0x00 ( /W  32) Control Register */
  __IO  __QSPI_MR_bits_t               QSPI_MR;       /**< Offset: 0x04 (R/W  32) Mode Register */
  __I   __QSPI_RDR_bits_t              QSPI_RDR;      /**< Offset: 0x08 (R/   32) Receive Data Register */
  __O   __QSPI_TDR_bits_t              QSPI_TDR;      /**< Offset: 0x0C ( /W  32) Transmit Data Register */
  __I   __QSPI_SR_bits_t               QSPI_SR;       /**< Offset: 0x10 (R/   32) Status Register */
  __O   __QSPI_IER_bits_t              QSPI_IER;      /**< Offset: 0x14 ( /W  32) Interrupt Enable Register */
  __O   __QSPI_IDR_bits_t              QSPI_IDR;      /**< Offset: 0x18 ( /W  32) Interrupt Disable Register */
  __I   __QSPI_IMR_bits_t              QSPI_IMR;      /**< Offset: 0x1C (R/   32) Interrupt Mask Register */
  __IO  __QSPI_SCR_bits_t              QSPI_SCR;      /**< Offset: 0x20 (R/W  32) Serial Clock Register */
  __I   uint8_t                        Reserved1[0x0C];
  __IO  __QSPI_IAR_bits_t              QSPI_IAR;      /**< Offset: 0x30 (R/W  32) Instruction Address Register */
  __IO  __QSPI_ICR_bits_t              QSPI_ICR;      /**< Offset: 0x34 (R/W  32) Instruction Code Register */
  __IO  __QSPI_IFR_bits_t              QSPI_IFR;      /**< Offset: 0x38 (R/W  32) Instruction Frame Register */
  __I   uint8_t                        Reserved2[0x04];
  __IO  __QSPI_SMR_bits_t              QSPI_SMR;      /**< Offset: 0x40 (R/W  32) Scrambling Mode Register */
  __O   __QSPI_SKR_bits_t              QSPI_SKR;      /**< Offset: 0x44 ( /W  32) Scrambling Key Register */
  __I   uint8_t                        Reserved3[0x9C];
  __IO  __QSPI_WPMR_bits_t             QSPI_WPMR;     /**< Offset: 0xE4 (R/W  32) Write Protection Mode Register */
  __I   __QSPI_WPSR_bits_t             QSPI_WPSR;     /**< Offset: 0xE8 (R/   32) Write Protection Status Register */
} qspi_registers_t;
/** @}  end of Quad Serial Peripheral Interface */

#endif /* _PIC32CZ_CA70_QSPI_COMPONENT_H_ */
