/**
 * \brief Component description for PIC32CZ/CA70 SSC
 *
...
#ifndef _PIC32CZ_CA70_SSC_COMPONENT_H_
#define _PIC32CZ_CA70_SSC_COMPONENT_H_

/** \addtogroup PIC32CZ_CA70_SSC Synchronous Serial Controller
 *  @{
 */
/* ========================================================================== */
...
#define SSC_SR_CP_Msk                         (0x3U << SSC_SR_CP_Pos)                        /**< (SSC_SR Mask) CP */
...
#define SSC_IER_CP_Msk                        (0x3U << SSC_IER_CP_Pos)                       /**< (SSC_IER Mask) CP */
...
#define SSC_IDR_CP_Msk                        (0x3U << SSC_IDR_CP_Pos)                       /**< (SSC_IDR Mask) CP */
...
#define SSC_IMR_CP_Msk                        (0x3U << SSC_IMR_CP_Pos)                       /**< (SSC_IMR Mask) CP */
...
typedef struct
{
  __O   __SSC_CR_bits_t                SSC_CR;        /**< Offset: 0x00 ( /W  32) Control Register */
  __IO  __SSC_CMR_bits_t               SSC_CMR;       /**< Offset: 0x04 (R/W  32) Clock Mode Register */
  __I   uint8_t                        Reserved1[0x08];
  __IO  __SSC_RCMR_bits_t              SSC_RCMR;      /**< Offset: 0x10 (R/W  32) Receive Clock Mode Register */
  __IO  __SSC_RFMR_bits_t              SSC_RFMR;      /**< Offset: 0x14 (R/W  32) Receive Frame Mode Register */
  __IO  __SSC_TCMR_bits_t              SSC_TCMR;      /**< Offset: 0x18 (R/W  32) Transmit Clock Mode Register */
  __IO  __SSC_TFMR_bits_t              SSC_TFMR;      /**< Offset: 0x1C (R/W  32) Transmit Frame Mode Register */
  __I   __SSC_RHR_bits_t               SSC_RHR;       /**< Offset: 0x20 (R/   32) Receive Holding Register */
  __O   __SSC_THR_bits_t               SSC_THR;       /**< Offset: 0x24 ( /W  32) Transmit Holding Register */
  __I   uint8_t                        Reserved2[0x08];
  __I   __SSC_RSHR_bits_t              SSC_RSHR;      /**< Offset: 0x30 (R/   32) Receive Sync. Holding Register */
  __IO  __SSC_TSHR_bits_t              SSC_TSHR;      /**< Offset: 0x34 (R/W  32) Transmit Sync. Holding Register */
  __IO  __SSC_RC0R_bits_t              SSC_RC0R;      /**< Offset: 0x38 (R/W  32) Receive Compare 0 Register */
  __IO  __SSC_RC1R_bits_t              SSC_RC1R;      /**< Offset: 0x3C (R/W  32) Receive Compare 1 Register */
  __I   __SSC_SR_bits_t                SSC_SR;        /**< Offset: 0x40 (R/   32) Status Register */
  __O   __SSC_IER_bits_t               SSC_IER;       /**< Offset: 0x44 ( /W  32) Interrupt Enable Register */
  __O   __SSC_IDR_bits_t               SSC_IDR;       /**< Offset: 0x48 ( /W  32) Interrupt Disable Register */
  __I   __SSC_IMR_bits_t               SSC_IMR;       /**< Offset: 0x4C (R/   32) Interrupt Mask Register */
  __I   uint8_t                        Reserved3[0x94];
  __IO  __SSC_WPMR_bits_t              SSC_WPMR;      /**< Offset: 0xE4 (R/W  32) Write Protection Mode Register */
  __I   __SSC_WPSR_bits_t              SSC_WPSR;      /**< Offset: 0xE8 (R/   32) Write Protection Status Register */
} ssc_registers_t;
/** @}  end of Synchronous Serial Controller */

#endif /* _PIC32CZ_CA70_SSC_COMPONENT_H_ */
