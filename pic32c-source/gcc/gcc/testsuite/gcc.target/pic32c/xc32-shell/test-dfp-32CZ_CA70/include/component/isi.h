/**
 * \brief Component description for PIC32CZ/CA70 ISI
 *
...
#ifndef _PIC32CZ_CA70_ISI_COMPONENT_H_
#define _PIC32CZ_CA70_ISI_COMPONENT_H_

/** \addtogroup PIC32CZ_CA70_ISI Image Sensor Interface
 *  @{
 */
/* ========================================================================== */
...
typedef struct
{
  __IO  __ISI_CFG1_bits_t              ISI_CFG1;      /**< Offset: 0x00 (R/W  32) ISI Configuration 1 Register */
  __IO  __ISI_CFG2_bits_t              ISI_CFG2;      /**< Offset: 0x04 (R/W  32) ISI Configuration 2 Register */
  __IO  __ISI_PSIZE_bits_t             ISI_PSIZE;     /**< Offset: 0x08 (R/W  32) ISI Preview Size Register */
  __IO  __ISI_PDECF_bits_t             ISI_PDECF;     /**< Offset: 0x0C (R/W  32) ISI Preview Decimation Factor Register */
  __IO  __ISI_Y2R_SET0_bits_t          ISI_Y2R_SET0;  /**< Offset: 0x10 (R/W  32) ISI Color Space Conversion YCrCb To RGB Set 0 Register */
  __IO  __ISI_Y2R_SET1_bits_t          ISI_Y2R_SET1;  /**< Offset: 0x14 (R/W  32) ISI Color Space Conversion YCrCb To RGB Set 1 Register */
  __IO  __ISI_R2Y_SET0_bits_t          ISI_R2Y_SET0;  /**< Offset: 0x18 (R/W  32) ISI Color Space Conversion RGB To YCrCb Set 0 Register */
  __IO  __ISI_R2Y_SET1_bits_t          ISI_R2Y_SET1;  /**< Offset: 0x1C (R/W  32) ISI Color Space Conversion RGB To YCrCb Set 1 Register */
  __IO  __ISI_R2Y_SET2_bits_t          ISI_R2Y_SET2;  /**< Offset: 0x20 (R/W  32) ISI Color Space Conversion RGB To YCrCb Set 2 Register */
  __O   __ISI_CR_bits_t                ISI_CR;        /**< Offset: 0x24 ( /W  32) ISI Control Register */
  __I   __ISI_SR_bits_t                ISI_SR;        /**< Offset: 0x28 (R/   32) ISI Status Register */
  __O   __ISI_IER_bits_t               ISI_IER;       /**< Offset: 0x2C ( /W  32) ISI Interrupt Enable Register */
  __O   __ISI_IDR_bits_t               ISI_IDR;       /**< Offset: 0x30 ( /W  32) ISI Interrupt Disable Register */
  __I   __ISI_IMR_bits_t               ISI_IMR;       /**< Offset: 0x34 (R/   32) ISI Interrupt Mask Register */
  __O   __ISI_DMA_CHER_bits_t          ISI_DMA_CHER;  /**< Offset: 0x38 ( /W  32) DMA Channel Enable Register */
  __O   __ISI_DMA_CHDR_bits_t          ISI_DMA_CHDR;  /**< Offset: 0x3C ( /W  32) DMA Channel Disable Register */
  __I   __ISI_DMA_CHSR_bits_t          ISI_DMA_CHSR;  /**< Offset: 0x40 (R/   32) DMA Channel Status Register */
  __IO  __ISI_DMA_P_ADDR_bits_t        ISI_DMA_P_ADDR; /**< Offset: 0x44 (R/W  32) DMA Preview Base Address Register */
  __IO  __ISI_DMA_P_CTRL_bits_t        ISI_DMA_P_CTRL; /**< Offset: 0x48 (R/W  32) DMA Preview Control Register */
  __IO  __ISI_DMA_P_DSCR_bits_t        ISI_DMA_P_DSCR; /**< Offset: 0x4C (R/W  32) DMA Preview Descriptor Address Register */
  __IO  __ISI_DMA_C_ADDR_bits_t        ISI_DMA_C_ADDR; /**< Offset: 0x50 (R/W  32) DMA Codec Base Address Register */
  __IO  __ISI_DMA_C_CTRL_bits_t        ISI_DMA_C_CTRL; /**< Offset: 0x54 (R/W  32) DMA Codec Control Register */
  __IO  __ISI_DMA_C_DSCR_bits_t        ISI_DMA_C_DSCR; /**< Offset: 0x58 (R/W  32) DMA Codec Descriptor Address Register */
  __I   uint8_t                        Reserved1[0x88];
  __IO  __ISI_WPMR_bits_t              ISI_WPMR;      /**< Offset: 0xE4 (R/W  32) Write Protection Mode Register */
  __I   __ISI_WPSR_bits_t              ISI_WPSR;      /**< Offset: 0xE8 (R/   32) Write Protection Status Register */
} isi_registers_t;
/** @}  end of Image Sensor Interface */

#endif /* _PIC32CZ_CA70_ISI_COMPONENT_H_ */
