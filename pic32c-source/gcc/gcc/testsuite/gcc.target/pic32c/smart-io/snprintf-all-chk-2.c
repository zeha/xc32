/* 
   smart-io symbol resolution test: snprintf-all-chk-2.c
   Invoke variants of stdio function snprintf and check for
   resolution to smart-io function via disassembly.
*/
/* { dg-do link } */
/* { dg-options "-msmart-io" } */
/* { dg-final { scan-disasm "bl\s.*\<_snprintf_cdeEfFgGnopsuxX\>" } } */
#define PREFIX sn
#define ROOT printf
#include "harness.h"
