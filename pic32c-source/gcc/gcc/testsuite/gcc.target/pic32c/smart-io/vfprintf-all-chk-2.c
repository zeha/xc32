/* 
   smart-io symbol resolution test: vfprintf-all-chk-2.c
   Invoke variants of stdio function vfprintf and check for
   resolution to smart-io function via disassembly.
*/
/* { dg-do link } */
/* { dg-options "-msmart-io" } */
/* { dg-final { scan-disasm "bl\s.*\<_vfprintf_cdeEfFgGnopsuxX\>" } } */
#define PREFIX vf
#define ROOT printf
#include "harness.h"
