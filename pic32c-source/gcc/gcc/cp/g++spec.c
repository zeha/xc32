...
#ifdef _BUILD_MCHP_
#define LIBSTDCXX_NOEXCEPT "stdc++-noexcept"
#define LIBSTDCXX_PROFILE_NOEXCEPT LIBSTDCXX_NOEXCEPT
#endif
		      ...
		      int *in_added_libraries)
{
...
#ifdef _BUILD_MCHP_
  /* True if exceptions or rtti are requested. */
  int exceptions = 1;
  int rtti = 1;
#endif
...
#if defined(_BUILD_MCHP_) && defined(TARGET_MCHP_PIC32MX) && defined(XC32CPPLIB_OPTION)
  /* fix me */
  ...
  if (library > 0)
	...
	generate_option (OPT_l,
			 saw_profile_flag ? LIBSTDCXX_PROFILE_NOEXCEPT
					  : LIBSTDCXX_NOEXCEPT,
