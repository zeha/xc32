    ...
    if ((DECL_NAME(x) != NULL) && (DECL_NAME(duplicate_member) != NULL) &&
      ...
      { 
            ...
            DECL_FIELD_OFFSET(duplicate_member)!=NULL_TREE)
        {
		  ...
		  */
          /* Replace tree_low_cst (..., 1) with tree_to_uhwi */
          if ((level >1) ||
              (tree_to_uhwi(DECL_FIELD_OFFSET (x)) != 
               tree_to_uhwi(DECL_FIELD_OFFSET (duplicate_member))) ||
              (tree_to_uhwi(DECL_FIELD_BIT_OFFSET(x)) != 
               tree_to_uhwi(DECL_FIELD_BIT_OFFSET(duplicate_member))) ||
...
detect_field_duplicates_hash (tree fieldlist,
			      hash_table <nofree_ptr_hash <tree_node> > *htab, tree original_fieldlist, enum tree_code code)
#else
detect_field_duplicates_hash (tree fieldlist,
