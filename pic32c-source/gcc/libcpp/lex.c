...
/*
  XC32E-693:
    GCC treats files with the suffixes ".s" and ".S" differently: the preprocessor 
  is run on files with the ".S" (capital s)suffix, not on the ones with the ".s" 
  suffix. Because of this, compiling .S files with machine instructions having 
  as opcodes "and", "or", etc leads to the warning below 
*/
