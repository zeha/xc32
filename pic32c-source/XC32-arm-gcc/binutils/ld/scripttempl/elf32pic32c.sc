...
if [ "x$ENABLE_TCM" == "xyes" ]; then
  TCM_REGIONS="
     ${TEXT_TCM_REGION} (rwx) : ORIGIN = ${TEXT_TCM_START_ADDR}, LENGTH = ${TEXT_TCM_LENGTH}
     ${DATA_TCM_REGION} (rwx) : ORIGIN = ${DATA_TCM_START_ADDR}, LENGTH = ${DATA_TCM_LENGTH}
   "
else
  TCM_REGIONS=""
fi
...
MEMORY
{
  ${TEXT_REGION} (rx) : ORIGIN = ${TEXT_START_ADDR}, LENGTH = ${TEXT_LENGTH}
  ${DATA_REGION} (rwx) : ORIGIN = ${DATA_START_ADDR}, LENGTH = ${DATA_LENGTH} - (${TEXT_TCM_LENGTH} + ${DATA_TCM_LENGTH})
  ${OTHER_REGIONS}
  ${TCM_REGIONS}
}
