...
/* LG - ARM specific*/
MASK4( .ARM.extab, 1, code, 0)
MASK4( .ARM.exidx, 1, code, 0)
MASK4( .init_array, 1, code, 0)
MASK4( .fini_array, 1, code, 0)
MASK4( .gnu.linkonce.armextab, 1, code, 0)
MASK4( .gnu.linkonce.armexidx, 1, code, 0)
/* TCM */
MASK4( .text_itcm, 1, code, itcm )
MASK4( .data_dtcm, 1, data, dtcm )
MASK4(  .bss_dtcm, 1, bss, dtcm )
