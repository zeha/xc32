/* 
   smart-io symbol resolution test: fprintf-all-chk-2.c
   Invoke variants of stdio function fprintf and check for
   resolution to smart-io function via disassembly.
*/
/* { dg-do link } */
/* { dg-options "-msmart-io" } */
/* { dg-final { scan-disasm "bl\s.*\<_fprintf_cdeEfFgGnopsuxX\>" } } */
#define PREFIX f
#define ROOT printf
#include "harness.h"
