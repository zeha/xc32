/**
 * \brief Component description for PIC32CZ/CA70 MATRIX
 *
...
#ifndef _PIC32CZ_CA70_MATRIX_COMPONENT_H_
#define _PIC32CZ_CA70_MATRIX_COMPONENT_H_

/** \addtogroup PIC32CZ_CA70_MATRIX AHB Bus Matrix
 *  @{
 */
/* ========================================================================== */
...
#define MATRIX_MRCR_RCB_Msk                   (0x1FFFU << MATRIX_MRCR_RCB_Pos)               /**< (MATRIX_MRCR Mask) RCB */
...
#define CCFG_SYSIO_SYSIO_Msk                  (0x1FU << CCFG_SYSIO_SYSIO_Pos)                /**< (CCFG_SYSIO Mask) SYSIO */
...
#define CCFG_SMCNFCS_SMC_NFCS_Msk             (0xFU << CCFG_SMCNFCS_SMC_NFCS_Pos)            /**< (CCFG_SMCNFCS Mask) SMC_NFCS */
...
/** \brief MATRIX_PR register offsets definitions */
...
typedef struct
{
  __IO  __MATRIX_PRAS_bits_t           MATRIX_PRAS;   /**< Offset: 0x00 (R/W  32) Priority Register A for Slave 0 */
  __IO  __MATRIX_PRBS_bits_t           MATRIX_PRBS;   /**< Offset: 0x04 (R/W  32) Priority Register B for Slave 0 */
} matrixpr_registers_t;

#define MATRIXPR_NUMBER 9
/** \brief MATRIX register API structure */
typedef struct
{
  __IO  __MATRIX_MCFG_bits_t           MATRIX_MCFG[12]; /**< Offset: 0x00 (R/W  32) Master Configuration Register 0 */
  __I   uint8_t                        Reserved1[0x10];
  __IO  __MATRIX_SCFG_bits_t           MATRIX_SCFG[9]; /**< Offset: 0x40 (R/W  32) Slave Configuration Register 0 */
  __I   uint8_t                        Reserved2[0x1C];
        matrixpr_registers_t           MATRIX_PR[MATRIXPR_NUMBER]; /**< Offset: 0x80 Priority Register A for Slave 0 */
  __I   uint8_t                        Reserved3[0x38];
  __IO  __MATRIX_MRCR_bits_t           MATRIX_MRCR;   /**< Offset: 0x100 (R/W  32) Master Remap Control Register */
  __I   uint8_t                        Reserved4[0x0C];
  __IO  __CCFG_CAN0_bits_t             CCFG_CAN0;     /**< Offset: 0x110 (R/W  32) CAN0 Configuration Register */
  __IO  __CCFG_SYSIO_bits_t            CCFG_SYSIO;    /**< Offset: 0x114 (R/W  32) System I/O and CAN1 Configuration Register */
  __IO  __CCFG_PCCR_bits_t             CCFG_PCCR;     /**< Offset: 0x118 (R/W  32) Peripheral Clock Configuration Register */
  __IO  __CCFG_DYNCKG_bits_t           CCFG_DYNCKG;   /**< Offset: 0x11C (R/W  32) Dynamic Clock Gating Register */
  __I   uint8_t                        Reserved5[0x04];
  __IO  __CCFG_SMCNFCS_bits_t          CCFG_SMCNFCS;  /**< Offset: 0x124 (R/W  32) SMC NAND Flash Chip Select Configuration Register */
  __I   uint8_t                        Reserved6[0xBC];
  __IO  __MATRIX_WPMR_bits_t           MATRIX_WPMR;   /**< Offset: 0x1E4 (R/W  32) Write Protection Mode Register */
  __I   __MATRIX_WPSR_bits_t           MATRIX_WPSR;   /**< Offset: 0x1E8 (R/   32) Write Protection Status Register */
} matrix_registers_t;
/** @}  end of AHB Bus Matrix */

#endif /* _PIC32CZ_CA70_MATRIX_COMPONENT_H_ */
