/**
 * \brief Component description for PIC32CZ/CA70 CHIPID
 *
...
#ifndef _PIC32CZ_CA70_CHIPID_COMPONENT_H_
#define _PIC32CZ_CA70_CHIPID_COMPONENT_H_

/** \addtogroup PIC32CZ_CA70_CHIPID Chip Identifier
 *  @{
 */
/* ========================================================================== */
...
#define   CHIPID_CIDR_ARCH_PIC32CZCA70_Val    (0x12U)                                        /**< (CHIPID_CIDR) PIC32CZ/CA70  */
#define CHIPID_CIDR_ARCH_PIC32CZCA70          (CHIPID_CIDR_ARCH_PIC32CZCA70_Val << CHIPID_CIDR_ARCH_Pos)  /**< (CHIPID_CIDR) PIC32CZ/CA70 Position  */
...
typedef struct
{
  __I   __CHIPID_CIDR_bits_t           CHIPID_CIDR;   /**< Offset: 0x00 (R/   32) Chip ID Register */
  __I   __CHIPID_EXID_bits_t           CHIPID_EXID;   /**< Offset: 0x04 (R/   32) Chip ID Extension Register */
} chipid_registers_t;
/** @}  end of Chip Identifier */

#endif /* _PIC32CZ_CA70_CHIPID_COMPONENT_H_ */
