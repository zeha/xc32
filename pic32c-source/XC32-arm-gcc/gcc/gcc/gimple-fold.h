...
bool gimple_fold_builtin_sprintf (gimple_stmt_iterator *gsi, int pos = 0);
bool gimple_fold_builtin_snprintf (gimple_stmt_iterator *gsi, int pos = 0);
bool gimple_fold_builtin_fprintf (gimple_stmt_iterator *, tree, tree, tree,
                                  enum built_in_function fcode);
bool gimple_fold_builtin_printf (gimple_stmt_iterator *gsi, tree fmt,
