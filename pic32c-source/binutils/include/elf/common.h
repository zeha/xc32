...
/* All uses of the SHF_GNU_MBIND flag have been disabled: SHF_GNU_MBIND 
  conflicts with the XC32 SHF_ABSOLUTE flag (XC32E-660) */
...
#if TARGET_IS_PIC32MX /* lghica co-resident pic32 */
