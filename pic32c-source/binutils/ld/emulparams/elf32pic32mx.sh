...
# MERGE-NOTES: it was fun figuring out where procdefs.ld came from,
# which is where processor.o came from, for unknown reasons.
# I've removed INCLUDE procdefs.ld and am just putting
# the 'essentials' in here. The essentials are essential because
# the linker expects very specific regions.
INPUT_FILES="
/* start procdefs.ld, minus the legacy peripheral lib stuff. */
/*************************************************************************
