...
#if defined(TARGET_IS_PIC32C) || defined(TARGET_IS_PIC32MX)
  /* MERGE-TODO: this and the above were forced with ' || 1'
     again indicating configure issues. */
...
#if defined(TARGET_IS_PIC32C) || defined(TARGET_IS_PIC32MX)
/* MERGE-NOTES: these guards weren't forced in the original. who knows? */
...
extern char *altNameforStack;
extern char *altNameforSplim;
extern char *altNamefor_dtcm_Stack;
extern char *altNamefor_dtcm_Splim;
