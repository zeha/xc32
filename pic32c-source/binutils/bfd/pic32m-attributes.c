...
void pic32_set_extended_attributes (asection *sec, unsigned int mask,
				    unsigned char flag_debug);

int pic32_set_implied_attributes (asection *, unsigned char);

int pic32_is_valid_attributes (unsigned int, unsigned char);
