...
/* MERGE-NOTES: 
   This leads to some unpleasant warnings as the included file
   declares some generically-named static globals.
*/
...
/* NB: this defines an initializer for struct bfd_arch_info in the
   bfd/bfd.h generated in the build directory. fields must match. */
/* MERGE-NOTES: added fill field (new), using the default function as
...
#define ARCH(machine, printable_name, default_machine, next, flags)            \
  {                                                                            \
      ...
      32,                     /* bits_per_address */                           \
      8,                      /* bits_per_byte */                              \
      bfd_arch_mips,          /* bfd_architecture */                           \
      machine,                /* mach */                                       \
      "mips",                 /* arch_name */                                  \
      printable_name,         /* printable_name */                             \
      1,                      /* section _align_power */                       \
      default_machine,        /* the_default */                                \
...
int pic32_is_generic_machine (unsigned int machine);
...
void
process_resource_file (unsigned int procID ATTRIBUTE_UNUSED,
		       int debug ATTRIBUTE_UNUSED)
{
