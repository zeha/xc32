...
#define SEC_INFO_TYPE_EH_FRAME_ENTRY 6
  ...
  unsigned int init:1; /* initialization needed */
  unsigned int bfa:1;  /* placed by best-fit allocator */

  /* procedural abstraction */
  unsigned int nopa:1;

  /* NB: 31 flag bits in all - you must update the BFD_FAKE_SECTION macro
     when flags are added/removed */
#else
...
#if defined(TARGET_IS_PIC32C) || defined(TARGET_IS_PIC32MX)
/* MERGE-TODO: unify with PIC32M and update guard. */
#define BFD_FAKE_SECTION(SEC, SYM, NAME, IDX, FLAGS)                   \
  ...
  /* memory, heap, stack, ramfunc, coherent, serial_mem,           */  \
     0,        0,     0,       0,         0,          0,               \
  /* linked, shared, preserved, */ \
     0,      0,      0,            \
  /* itcm, dtcm, init, bfa, nopa */  \
     0,    0,    0,    0,   0,       \
