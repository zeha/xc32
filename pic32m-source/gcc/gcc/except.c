  ...
  if (exception_section)
      ...
      if (targetm_common.have_named_sections)
	{
	  ...
	  if (flag_function_sections
        ...
        /*
          mchp_subtarget_encode_section_info inserts this special character "|"
            to encode an extended attribute as part of function's name.
          If the "|" character is not removed here, then the assembler will complain 
            about an invalid character used to name a section.
        */
        fnname = targetm.strip_name_encoding(mchp_strip_name_encoding(fnname));
#endif
