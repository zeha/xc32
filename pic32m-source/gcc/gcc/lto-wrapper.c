...
cont1:
  ...
  // XC32-1690 - do not run the PA when invoking the linker to gather the 
  // compile-time generated debug-info into a single input for the final link
  obstack_ptr_grow (&argv_obstack, "-mno-pa");
#endif
