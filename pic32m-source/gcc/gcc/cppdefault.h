...
/* MCHP: see definition in cppdefault.c. need this in the backend. */
#ifdef _BUILD_MCHP_
extern const char cpp_NATIVE_SYSTEM_HEADER_DIR[];
extern const size_t cpp_NATIVE_SYSTEM_HEADER_DIR_len;
#endif
