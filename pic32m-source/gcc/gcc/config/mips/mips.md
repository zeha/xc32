...
(define_insn "pic32_di"
  ...
  ""
  {
    return pic32_output_di (operands[0]);
  }
  [(set_attr "type"     "trap")
   (set_attr "mode"     "none")])
...
(define_insn "pic32_ei"
  ...
  ""
  {
    return pic32_output_ei (operands[0]);
  }
  [(set_attr "type"     "trap")
   (set_attr "mode"     "none")])
...
(define_insn "pic32_jump_to_symbol"
  [(call (mem:SI (match_operand 0 "symbol_ref_operand" "S"))
	 (const_int 0))]
  "mchp_is_vector_dispatch_call()"
  {
    #define ASM_SWITCH    ".set\tnoreorder"
    #define JUMP_TO_SYM   "j\t%0"

    return ASM_SWITCH "\;" JUMP_TO_SYM "\;nop" ;
  }
  [(set_attr "type" "jump")])

(define_insn "pic32_jump_to_addr_in_reg"
  [(call (mem:SI (match_operand 0 "symbol_ref_operand" "S"))
	 (match_operand:SI 1 "register_operand"))]
  "mchp_is_vector_dispatch_call()"
  {
    #define ASM_SWITCH    ".set\tmacro\;.set\tnoreorder"
    #define LOAD_ADDR     "la\t%1,%0"
    #define JUMP_TO_ADDR  "jr\t%1"

    return ASM_SWITCH "\;" LOAD_ADDR "\;" JUMP_TO_ADDR "\;nop" ;
  }
  [(set_attr "type" "jump")])
