...
void mchp_handle_align_pragma(ATTRIBUTE_UNUSED struct cpp_reader *pfile) {
  int c;
  tree x;
...
void mchp_handle_section_pragma (ATTRIBUTE_UNUSED struct cpp_reader *pfile) {
  int c;
  tree x;
  const char *name;
...
void mchp_handle_printf_args_pragma (ATTRIBUTE_UNUSED struct cpp_reader *pfile) {
  mchp_pragma_printf_args = 1;
}

void mchp_handle_scanf_args_pragma (ATTRIBUTE_UNUSED struct cpp_reader *pfile) {
  mchp_pragma_scanf_args = 1;
}

void mchp_handle_inline_pragma (ATTRIBUTE_UNUSED struct cpp_reader *pfile) {
  int c;
  tree x;
...
void mchp_handle_keep_pragma (ATTRIBUTE_UNUSED struct cpp_reader *pfile) {
  mchp_pragma_keep = 1;
}

void mchp_handle_coherent_pragma (ATTRIBUTE_UNUSED struct cpp_reader *pfile) {
  mchp_pragma_coherent = 1;
}

void mchp_handle_required_pragma(ATTRIBUTE_UNUSED struct cpp_reader *pfile) {
  int c;
  tree x;
...
void mchp_handle_optimize_pragma (ATTRIBUTE_UNUSED struct cpp_reader *pfile) {
...
void mchp_handle_region_pragma (ATTRIBUTE_UNUSED struct cpp_reader *pfile) {
