/**
 * \brief Component description for PIC32CZ/CA70 PMC
 *
...
#ifndef _PIC32CZ_CA70_PMC_COMPONENT_H_
#define _PIC32CZ_CA70_PMC_COMPONENT_H_

/** \addtogroup PIC32CZ_CA70_PMC Power Management Controller
 *  @{
 */
/* ========================================================================== */
...
#define PMC_SCER_Msk                          (0x00007F20UL)                                 /**< (PMC_SCER) Register Mask  */
...
#define PMC_SCDR_Msk                          (0x00007F20UL)                                 /**< (PMC_SCDR) Register Mask  */
...
#define PMC_SCSR_Msk                          (0x00007F21UL)                                 /**< (PMC_SCSR) Register Mask  */
...
#define PMC_PCER0_PID_Msk                     (0x1FFFFFFU << PMC_PCER0_PID_Pos)              /**< (PMC_PCER0 Mask) PID */
...
#define PMC_PCDR0_PID_Msk                     (0x1FFFFFFU << PMC_PCDR0_PID_Pos)              /**< (PMC_PCDR0 Mask) PID */
...
#define PMC_PCSR0_PID_Msk                     (0x1FFFFFFU << PMC_PCSR0_PID_Pos)              /**< (PMC_PCSR0 Mask) PID */
...
#define CKGR_UCKR_UPLLCOUNT_Msk               (0xFU << CKGR_UCKR_UPLLCOUNT_Pos)              /**< (CKGR_UCKR) UTMI PLL Startup Time Mask */
...
#define   CKGR_MOR_MOSCRCF_4_MHz_Val          (0x0U)                                         /**< (CKGR_MOR) The RC oscillator frequency is at 4 MHz  */
...
#define   PMC_MCKR_CSS_SLOW_CLK_Val           (0x0U)                                         /**< (PMC_MCKR) SLCK is selected  */
#define   PMC_MCKR_CSS_MAIN_CLK_Val           (0x1U)                                         /**< (PMC_MCKR) MAINCK is selected  */
#define   PMC_MCKR_CSS_PLLA_CLK_Val           (0x2U)                                         /**< (PMC_MCKR) PLLACK is selected  */
#define   PMC_MCKR_CSS_UPLL_CLK_Val           (0x3U)                                         /**< (PMC_MCKR) UPPLLCKDIV is selected  */
...
#define   PMC_MCKR_MDIV_EQ_PCK_Val            (0x0U)                                         /**< (PMC_MCKR) MCK is FCLK divided by 1.  */
#define   PMC_MCKR_MDIV_PCK_DIV2_Val          (0x1U)                                         /**< (PMC_MCKR) MCK is FCLK divided by 2.  */
#define   PMC_MCKR_MDIV_PCK_DIV4_Val          (0x2U)                                         /**< (PMC_MCKR) MCK is FCLK divided by 4.  */
#define   PMC_MCKR_MDIV_PCK_DIV3_Val          (0x3U)                                         /**< (PMC_MCKR) MCK is FCLK divided by 3.  */
...
#define   PMC_PCK_CSS_SLOW_CLK_Val            (0x0U)                                         /**< (PMC_PCK) SLCK is selected  */
#define   PMC_PCK_CSS_MAIN_CLK_Val            (0x1U)                                         /**< (PMC_PCK) MAINCK is selected  */
#define   PMC_PCK_CSS_PLLA_CLK_Val            (0x2U)                                         /**< (PMC_PCK) PLLACK is selected  */
#define   PMC_PCK_CSS_UPLL_CLK_Val            (0x3U)                                         /**< (PMC_PCK) UPLLCKDIV is selected  */
#define   PMC_PCK_CSS_MCK_Val                 (0x4U)                                         /**< (PMC_PCK) MCK is selected  */
...
#define PMC_IER_Msk                           (0x00277F4BUL)                                 /**< (PMC_IER) Register Mask  */
#define PMC_IER_PCKRDY_Pos                    (8)                                            /**< (PMC_IER Position) Programmable Clock Ready x Interrupt Enable */
#define PMC_IER_PCKRDY_Msk                    (0x7FU << PMC_IER_PCKRDY_Pos)                  /**< (PMC_IER Mask) PCKRDY */
...
#define PMC_IDR_Msk                           (0x00277F4BUL)                                 /**< (PMC_IDR) Register Mask  */
#define PMC_IDR_PCKRDY_Pos                    (8)                                            /**< (PMC_IDR Position) Programmable Clock Ready x Interrupt Disable */
#define PMC_IDR_PCKRDY_Msk                    (0x7FU << PMC_IDR_PCKRDY_Pos)                  /**< (PMC_IDR Mask) PCKRDY */
...
#define PMC_SR_Msk                            (0x003F7FCBUL)                                 /**< (PMC_SR) Register Mask  */
#define PMC_SR_PCKRDY_Pos                     (8)                                            /**< (PMC_SR Position) Programmable Clock Ready Status */
#define PMC_SR_PCKRDY_Msk                     (0x7FU << PMC_SR_PCKRDY_Pos)                   /**< (PMC_SR Mask) PCKRDY */
...
#define PMC_IMR_Msk                           (0x00277F4BUL)                                 /**< (PMC_IMR) Register Mask  */
#define PMC_IMR_PCKRDY_Pos                    (8)                                            /**< (PMC_IMR Position) Programmable Clock Ready x Interrupt Mask */
#define PMC_IMR_PCKRDY_Msk                    (0x7FU << PMC_IMR_PCKRDY_Pos)                  /**< (PMC_IMR Mask) PCKRDY */
...
#define PMC_FSMR_FSTT_Msk                     (0xFFFFU << PMC_FSMR_FSTT_Pos)                 /**< (PMC_FSMR Mask) FSTT */
...
#define PMC_PCER1_Msk                         (0x1F3FFFAFUL)                                 /**< (PMC_PCER1) Register Mask  */
...
#define PMC_PCDR1_Msk                         (0x1F3FFFAFUL)                                 /**< (PMC_PCDR1) Register Mask  */
...
#define PMC_PCSR1_Msk                         (0x1F3FFFAFUL)                                 /**< (PMC_PCSR1) Register Mask  */
...
#define   PMC_PCR_GCLKCSS_SLOW_CLK_Val        (0x0U)                                         /**< (PMC_PCR) SLCK is selected  */
#define   PMC_PCR_GCLKCSS_MAIN_CLK_Val        (0x1U)                                         /**< (PMC_PCR) MAINCK is selected  */
#define   PMC_PCR_GCLKCSS_PLLA_CLK_Val        (0x2U)                                         /**< (PMC_PCR) PLLACK is selected  */
#define   PMC_PCR_GCLKCSS_UPLL_CLK_Val        (0x3U)                                         /**< (PMC_PCR) UPLLCK is selected  */
#define   PMC_PCR_GCLKCSS_MCK_CLK_Val         (0x4U)                                         /**< (PMC_PCR) MCK is selected  */
...
#define PMC_SLPWK_ER1_Msk                     (0x1F3FFFAFUL)                                 /**< (PMC_SLPWK_ER1) Register Mask  */
...
#define PMC_SLPWK_DR1_Msk                     (0x1F3FFFAFUL)                                 /**< (PMC_SLPWK_DR1) Register Mask  */
...
#define PMC_SLPWK_SR1_Msk                     (0x1F3FFFAFUL)                                 /**< (PMC_SLPWK_SR1) Register Mask  */
...
#define PMC_SLPWK_ASR1_Msk                    (0x1F3FFFAFUL)                                 /**< (PMC_SLPWK_ASR1) Register Mask  */
...
typedef union
{
  ...
  uint32_t w;
} __PMC_APLLACR_bits_t;

#define PMC_APLLACR_DCOFLTSEL_Pos             (0)                                            /**< (PMC_APLLACR) DCO Filter Selection Position */
#define PMC_APLLACR_DCOFLTSEL_Msk             (0xFU << PMC_APLLACR_DCOFLTSEL_Pos)            /**< (PMC_APLLACR) DCO Filter Selection Mask */
...
#define PMC_APLLACR_FLTSEL_Msk                (0xFU << PMC_APLLACR_FLTSEL_Pos)               /**< (PMC_APLLACR) PLL Filter Selection Mask */
...
#define PMC_APLLACR_BIAS_Msk                  (0x3U << PMC_APLLACR_BIAS_Pos)                 /**< (PMC_APLLACR) Bias Voltage Selection Mask */
#define PMC_APLLACR_BIAS(value)               (PMC_APLLACR_BIAS_Msk & ((value) << PMC_APLLACR_BIAS_Pos))
#define PMC_APLLACR_Msk                       (0x000003FFUL)                                 /**< (PMC_APLLACR) Register Mask  */
...
#define PMC_WMST_WMST_Msk                     (0xFFU << PMC_WMST_WMST_Pos)                   /**< (PMC_WMST) Wait Mode Startup Time Mask */
...
#define PMC_WMST_KEY_Msk                      (0xFFU << PMC_WMST_KEY_Pos)                    /**< (PMC_WMST) Write Access Password Mask */
#define PMC_WMST_KEY(value)                   (PMC_WMST_KEY_Msk & ((value) << PMC_WMST_KEY_Pos))
#define   PMC_WMST_KEY_PASSWD_Val             (0x5AU)                                        /**< (PMC_WMST) Writing any other value in this field aborts the write operation.Always reads as 0.  */
...
#define PMC_WMST_Msk                          (0xFF0000FFUL)                                 /**< (PMC_WMST) Register Mask  */
...
typedef struct
{
  __O   __PMC_SCER_bits_t              PMC_SCER;      /**< Offset: 0x00 ( /W  32) System Clock Enable Register */
  __O   __PMC_SCDR_bits_t              PMC_SCDR;      /**< Offset: 0x04 ( /W  32) System Clock Disable Register */
  __I   __PMC_SCSR_bits_t              PMC_SCSR;      /**< Offset: 0x08 (R/   32) System Clock Status Register */
  __I   uint8_t                        Reserved1[0x04];
  __O   __PMC_PCER0_bits_t             PMC_PCER0;     /**< Offset: 0x10 ( /W  32) Peripheral Clock Enable Register 0 */
  __O   __PMC_PCDR0_bits_t             PMC_PCDR0;     /**< Offset: 0x14 ( /W  32) Peripheral Clock Disable Register 0 */
  __I   __PMC_PCSR0_bits_t             PMC_PCSR0;     /**< Offset: 0x18 (R/   32) Peripheral Clock Status Register 0 */
  __IO  __CKGR_UCKR_bits_t             CKGR_UCKR;     /**< Offset: 0x1C (R/W  32) UTMI Clock Register */
  __IO  __CKGR_MOR_bits_t              CKGR_MOR;      /**< Offset: 0x20 (R/W  32) Main Oscillator Register */
  __IO  __CKGR_MCFR_bits_t             CKGR_MCFR;     /**< Offset: 0x24 (R/W  32) Main Clock Frequency Register */
  __IO  __CKGR_PLLAR_bits_t            CKGR_PLLAR;    /**< Offset: 0x28 (R/W  32) PLLA Register */
  __I   uint8_t                        Reserved2[0x04];
  __IO  __PMC_MCKR_bits_t              PMC_MCKR;      /**< Offset: 0x30 (R/W  32) Master Clock Register */
  __I   uint8_t                        Reserved3[0x04];
  __IO  __PMC_USB_bits_t               PMC_USB;       /**< Offset: 0x38 (R/W  32) USB Clock Register */
  __I   uint8_t                        Reserved4[0x04];
  __IO  __PMC_PCK_bits_t               PMC_PCK[8];    /**< Offset: 0x40 (R/W  32) Programmable Clock Register (chid = 0) 0 */
  __O   __PMC_IER_bits_t               PMC_IER;       /**< Offset: 0x60 ( /W  32) Interrupt Enable Register */
  __O   __PMC_IDR_bits_t               PMC_IDR;       /**< Offset: 0x64 ( /W  32) Interrupt Disable Register */
  __I   __PMC_SR_bits_t                PMC_SR;        /**< Offset: 0x68 (R/   32) Status Register */
  __I   __PMC_IMR_bits_t               PMC_IMR;       /**< Offset: 0x6C (R/   32) Interrupt Mask Register */
  __IO  __PMC_FSMR_bits_t              PMC_FSMR;      /**< Offset: 0x70 (R/W  32) Fast Startup Mode Register */
  __IO  __PMC_FSPR_bits_t              PMC_FSPR;      /**< Offset: 0x74 (R/W  32) Fast Startup Polarity Register */
  __O   __PMC_FOCR_bits_t              PMC_FOCR;      /**< Offset: 0x78 ( /W  32) Fault Output Clear Register */
  __I   uint8_t                        Reserved5[0x68];
  __IO  __PMC_WPMR_bits_t              PMC_WPMR;      /**< Offset: 0xE4 (R/W  32) Write Protection Mode Register */
  __I   __PMC_WPSR_bits_t              PMC_WPSR;      /**< Offset: 0xE8 (R/   32) Write Protection Status Register */
  __I   uint8_t                        Reserved6[0x14];
  __O   __PMC_PCER1_bits_t             PMC_PCER1;     /**< Offset: 0x100 ( /W  32) Peripheral Clock Enable Register 1 */
  __O   __PMC_PCDR1_bits_t             PMC_PCDR1;     /**< Offset: 0x104 ( /W  32) Peripheral Clock Disable Register 1 */
  __I   __PMC_PCSR1_bits_t             PMC_PCSR1;     /**< Offset: 0x108 (R/   32) Peripheral Clock Status Register 1 */
  __IO  __PMC_PCR_bits_t               PMC_PCR;       /**< Offset: 0x10C (R/W  32) Peripheral Control Register */
  __IO  __PMC_OCR_bits_t               PMC_OCR;       /**< Offset: 0x110 (R/W  32) Oscillator Calibration Register */
  __O   __PMC_SLPWK_ER0_bits_t         PMC_SLPWK_ER0; /**< Offset: 0x114 ( /W  32) SleepWalking Enable Register 0 */
  __O   __PMC_SLPWK_DR0_bits_t         PMC_SLPWK_DR0; /**< Offset: 0x118 ( /W  32) SleepWalking Disable Register 0 */
  __I   __PMC_SLPWK_SR0_bits_t         PMC_SLPWK_SR0; /**< Offset: 0x11C (R/   32) SleepWalking Status Register 0 */
  __I   __PMC_SLPWK_ASR0_bits_t        PMC_SLPWK_ASR0; /**< Offset: 0x120 (R/   32) SleepWalking Activity Status Register 0 */
  __I   uint8_t                        Reserved7[0x0C];
  __IO  __PMC_PMMR_bits_t              PMC_PMMR;      /**< Offset: 0x130 (R/W  32) PLL Maximum Multiplier Value Register */
  __O   __PMC_SLPWK_ER1_bits_t         PMC_SLPWK_ER1; /**< Offset: 0x134 ( /W  32) SleepWalking Enable Register 1 */
  __O   __PMC_SLPWK_DR1_bits_t         PMC_SLPWK_DR1; /**< Offset: 0x138 ( /W  32) SleepWalking Disable Register 1 */
  __I   __PMC_SLPWK_SR1_bits_t         PMC_SLPWK_SR1; /**< Offset: 0x13C (R/   32) SleepWalking Status Register 1 */
  __I   __PMC_SLPWK_ASR1_bits_t        PMC_SLPWK_ASR1; /**< Offset: 0x140 (R/   32) SleepWalking Activity Status Register 1 */
  __I   __PMC_SLPWK_AIPR_bits_t        PMC_SLPWK_AIPR; /**< Offset: 0x144 (R/   32) SleepWalking Activity In Progress Register */
  __I   uint8_t                        Reserved8[0x10];
  __IO  __PMC_APLLACR_bits_t           PMC_APLLACR;   /**< Offset: 0x158 (R/W  32) Audio PLL Analog Configuration Register */
  __IO  __PMC_WMST_bits_t              PMC_WMST;      /**< Offset: 0x15C (R/W  32) Wait Mode Startup Time Register */
} pmc_registers_t;
/** @}  end of Power Management Controller */

#endif /* _PIC32CZ_CA70_PMC_COMPONENT_H_ */
