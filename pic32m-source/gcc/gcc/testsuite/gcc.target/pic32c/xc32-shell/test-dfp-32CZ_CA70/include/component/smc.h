/**
 * \brief Component description for PIC32CZ/CA70 SMC
 *
...
#ifndef _PIC32CZ_CA70_SMC_COMPONENT_H_
#define _PIC32CZ_CA70_SMC_COMPONENT_H_

/** \addtogroup PIC32CZ_CA70_SMC Static Memory Controller
 *  @{
 */
/* ========================================================================== */
...
#define   SMC_MODE_EXNW_MODE_DISABLED_Val     (0x0U)                                         /**< (SMC_MODE) Disabled-The NWAIT input signal is ignored on the corresponding chip select.  */
#define   SMC_MODE_EXNW_MODE_FROZEN_Val       (0x2U)                                         /**< (SMC_MODE) Frozen Mode-If asserted, the NWAIT signal freezes the current read or write cycle. After deassertion, the read/write cycle is resumed from the point where it was stopped.  */
#define   SMC_MODE_EXNW_MODE_READY_Val        (0x3U)                                         /**< (SMC_MODE) Ready Mode-The NWAIT signal indicates the availability of the external device at the end of the pulse of the controlling read or write signal, to complete the access. If high, the access normally completes. If low, the access is extended until NWAIT returns high.  */
...
/** \brief SMC_CS_NUMBER register offsets definitions */
...
typedef struct
{
  __IO  __SMC_SETUP_bits_t             SMC_SETUP;     /**< Offset: 0x00 (R/W  32) SMC Setup Register (CS_number = 0) */
  __IO  __SMC_PULSE_bits_t             SMC_PULSE;     /**< Offset: 0x04 (R/W  32) SMC Pulse Register (CS_number = 0) */
  __IO  __SMC_CYCLE_bits_t             SMC_CYCLE;     /**< Offset: 0x08 (R/W  32) SMC Cycle Register (CS_number = 0) */
  __IO  __SMC_MODE_bits_t              SMC_MODE;      /**< Offset: 0x0C (R/W  32) SMC Mode Register (CS_number = 0) */
} smccsnumber_registers_t;

#define SMCCSNUMBER_NUMBER 4
/** \brief SMC register API structure */
typedef struct
{
        smccsnumber_registers_t        SMC_CS_NUMBER[SMCCSNUMBER_NUMBER]; /**< Offset: 0x00 SMC Setup Register (CS_number = 0) */
  __I   uint8_t                        Reserved1[0x40];
  __IO  __SMC_OCMS_bits_t              SMC_OCMS;      /**< Offset: 0x80 (R/W  32) SMC Off-Chip Memory Scrambling Register */
  __O   __SMC_KEY1_bits_t              SMC_KEY1;      /**< Offset: 0x84 ( /W  32) SMC Off-Chip Memory Scrambling KEY1 Register */
  __O   __SMC_KEY2_bits_t              SMC_KEY2;      /**< Offset: 0x88 ( /W  32) SMC Off-Chip Memory Scrambling KEY2 Register */
  __I   uint8_t                        Reserved2[0x58];
  __IO  __SMC_WPMR_bits_t              SMC_WPMR;      /**< Offset: 0xE4 (R/W  32) SMC Write Protection Mode Register */
  __I   __SMC_WPSR_bits_t              SMC_WPSR;      /**< Offset: 0xE8 (R/   32) SMC Write Protection Status Register */
} smc_registers_t;
/** @}  end of Static Memory Controller */

#endif /* _PIC32CZ_CA70_SMC_COMPONENT_H_ */
