/* 
   smart-io symbol resolution test: printf-all-chk-2.c
   Invoke variants of stdio function printf and check for
   resolution to smart-io function via disassembly.
*/
/* { dg-do link } */
/* { dg-options "-msmart-io" } */
/* { dg-final { scan-disasm "bl\s.*\<_printf_cdeEfFgGnopsuxX\>" } } */
#define PREFIX 
#define ROOT printf
#include "harness.h"
