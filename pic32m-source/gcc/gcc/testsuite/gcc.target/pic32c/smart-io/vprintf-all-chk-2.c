/* 
   smart-io symbol resolution test: vprintf-all-chk-2.c
   Invoke variants of stdio function vprintf and check for
   resolution to smart-io function via disassembly.
*/
/* { dg-do link } */
/* { dg-options "-msmart-io" } */
/* { dg-final { scan-disasm "bl\s.*\<_vprintf_cdeEfFgGnopsuxX\>" } } */
#define PREFIX v
#define ROOT printf
#include "harness.h"
