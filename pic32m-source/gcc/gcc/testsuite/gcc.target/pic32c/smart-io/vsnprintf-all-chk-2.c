/* 
   smart-io symbol resolution test: vsnprintf-all-chk-2.c
   Invoke variants of stdio function vsnprintf and check for
   resolution to smart-io function via disassembly.
*/
/* { dg-do link } */
/* { dg-options "-msmart-io" } */
/* { dg-final { scan-disasm "bl\s.*\<_vsnprintf_cdeEfFgGnopsuxX\>" } } */
#define PREFIX vsn
#define ROOT printf
#include "harness.h"
