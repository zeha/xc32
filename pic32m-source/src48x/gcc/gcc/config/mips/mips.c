...
const char * UV2SI = "UV2SI";
const char * UQI = "UQI";
const char * UV4HI = "UV4HI";
const char * UV8QI = "UV8QI";
const char * V2SI = "V2SI";
const char * V4HI = "V4HI";
const char * V8QI = "V8QI";
const char * CVPOINTER = "const void *";
...
void write_builtin_proto(const char * name, uint32_t count,...) {
    ...
    if(parameters[0] == NULL) strcat(parameters,"void");
