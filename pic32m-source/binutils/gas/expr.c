...
# endif
      ...
      if (!is_part_of_name (*input_line_pointer))
	{
      ...
      /* MERGE-NOTE: to be double-checked */
      /* Add new .endof. operator for Microchip MPLAB X32 (PIC32) and XC16
       * Compilers */
...
#else
	    as_bad (_("syntax error in .startof. or .sizeof. or .endof."));
#endif
	  else
	    {
	      char *buf;
