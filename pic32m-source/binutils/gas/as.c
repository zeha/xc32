...
#if 0
    /* TODO not added yet */
    /* MERGE-TODO: I guess this makes sense for PIC32M, so we should
       check and enable with the right guard (definitely not PIC32C) 
       (also why a different output stream?) */
...
#if 0
      /* TODO not added yet */
      /* MERGE-TODO: see previous todo for pic32_resource_version */
#ifdef TARGET_IS_PIC32C
      if (pic32_has_processor_option) {
        fprintf (stdout, _("%s" "\n"), pic32_resource_version);
      }
