...
MASK4( .ctors,  1, code, 0 )
MASK4( .dtors,  1, code, 0 )
MASK4( .ramfunc, 1, ramfunc, 0 )
MASK4( .stack,    1, stack, 0 )
/* debug stuff that absolute cannot be 'data'. */
MASK4( .debug_abbrev, 1, info, 0)
MASK4( .debug_aranges, 1, info, 0)
MASK4( .debug_frame, 1, info, 0)
MASK4( .debug_info, 1, info, 0)
MASK4( .debug_line, 1, info, 0)
MASK4( .debug_loc, 1, info, 0)
MASK4( .debug_macinfo, 1, info, 0)
MASK4( .debug_pubnames, 1, info, 0)
MASK4( .debug_pubtypes, 1, info, 0)
MASK4( .debug_ranges, 1, info, 0)
MASK4( .debug_str, 1, info, 0)
MASK4( .debug_types, 1, info, 0)
MASK4( .zdebug_abbrev, 1, info, 0)
MASK4( .zdebug_aranges, 1, info, 0)
MASK4( .zdebug_frame, 1, info, 0)
MASK4( .zdebug_info, 1, info, 0)
MASK4( .zdebug_line, 1, info, 0)
MASK4( .zdebug_loc, 1, info, 0)
MASK4( .zdebug_macinfo, 1, info, 0)
MASK4( .zdebug_pubnames, 1, info, 0)
MASK4( .zdebug_pubtypes, 1, info, 0)
MASK4( .zdebug_ranges, 1, info, 0)
MASK4( .zdebug_str, 1, info, 0)
MASK4( .zdebug_types, 1, info, 0)
